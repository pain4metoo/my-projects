...
var ___CSS_LOADER_URL_IMPORT_7___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/image/main-bg-light.jpg */ "./src/assets/image/main-bg-light.jpg"), __webpack_require__.b);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header_item_btn {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: #fff;\n  cursor: pointer;\n  user-select: none;\n}\n\n.header {\n  background: rgba(20, 19, 17, 0.5);\n  backdrop-filter: blur(0.6rem);\n}\n.header_nav {\n  padding: 1.5rem 0rem;\n}\n.header_list {\n  display: flex;\n  justify-content: center;\n  list-style: none;\n  padding: 0;\n  margin: 0;\n}\n.header_list_item {\n  user-select: none;\n}\n.header_item_btn {\n  background: linear-gradient(180deg, rgba(148, 146, 141, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n  width: 15rem;\n  box-shadow: 0px 10px 4px 0px rgba(0, 0, 0, 0.25);\n  transition: 0.2s linear;\n}\n.header_item_btn:disabled {\n  opacity: 0.3;\n  cursor: not-allowed;\n}\n.header_item_btn:hover {\n  background: orange;\n}\n.header_item_btn:active {\n  background: linear-gradient(180deg, rgba(124, 121, 112, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n}\n.header_item_btn_active {\n  background: orange;\n}\n.header_list_item:not(:last-child) {\n  margin-right: 2rem;\n}\n.header_item_link {\n  color: black;\n  text-decoration: none;\n}\n.header_burger {\n  display: none;\n}\n\n@media (max-width: 870px) {\n  .header_item_btn {\n    width: 12rem;\n  }\n}\n@media (max-width: 670px) {\n  .header_item_btn {\n    font-size: 2.1rem;\n    width: 10.5rem;\n  }\n}\n@media (max-width: 570px) {\n  .header {\n    height: 7rem;\n  }\n  .header_nav {\n    padding: 0;\n  }\n  .header_list {\n    height: 100vh;\n    position: fixed;\n    display: none;\n    flex-direction: column;\n    align-items: center;\n    opacity: 0;\n    transform: translateY(-500rem);\n    transition: linear 0.5s;\n    z-index: -1;\n    background: black;\n    width: 100%;\n  }\n  .header_list_item:not(:last-child) {\n    margin-right: 0;\n  }\n  .header_list_show {\n    display: flex;\n    transform: translateY(0rem);\n    opacity: 1;\n    z-index: 1002;\n  }\n  .header_burger {\n    display: block;\n    position: fixed;\n    right: 2rem;\n    top: 1rem;\n    padding-top: 2rem;\n    cursor: pointer;\n    width: 4rem;\n    transition: linear 0.2s;\n    z-index: 1002;\n  }\n  .header_burger_item {\n    display: block;\n    height: 0.4rem;\n    background-color: beige;\n    margin-bottom: 0.5rem;\n    transition: all 0.5s;\n  }\n  .header_burger_item_rotate {\n    z-index: 1003;\n  }\n  .header_burger_item_rotate:nth-child(1) {\n    margin-bottom: -3px;\n    transform: rotate(45deg);\n  }\n  .header_burger_item_rotate:nth-child(2) {\n    transform: rotate(-45deg);\n  }\n}", "",{"version":3,"sources":["webpack://./src/style/variables.scss","webpack://./src/ts/components/header/header.scss"],"names":[],"mappings":"AAWA;EACE,iBAAA;EACA,iBAAA;EACA,YAAA;EACA,WATW;EAUX,eAAA;EACA,iBAAA;ACVF;;AALA;EACE,iCAAA;EACA,6BAAA;AAQF;AAPE;EACE,oBAAA;AASJ;AAPE;EACE,aAAA;EACA,uBAAA;EACA,gBAAA;EACA,UAAA;EACA,SAAA;AASJ;AAPE;EACE,iBAAA;AASJ;AAPE;EAEE,iGDZQ;ECaR,YAAA;EACA,gDAAA;EACA,uBAAA;AAQJ;AAPI;EACE,YAAA;EACA,mBAAA;AASN;AAPI;EACE,kBAAA;AASN;AAPI;EACE,iGAAA;AASN;AANE;EACE,kBAAA;AAQJ;AANE;EACE,kBAAA;AAQJ;AANE;EACE,YDrCY;ECsCZ,qBAAA;AAQJ;AANE;EACE,aAAA;AAQJ;;AAJA;EAEI;IACE,YAAA;EAMJ;AACF;AAFA;EAEI;IACE,iBAAA;IACA,cAAA;EAGJ;AACF;AACA;EACE;IACE,YAAA;EACF;EAAE;IACE,UAAA;EAEJ;EAAE;IACE,aAAA;IACA,eAAA;IACA,aAAA;IACA,sBAAA;IACA,mBAAA;IACA,UAAA;IACA,8BAAA;IACA,uBAAA;IACA,WAAA;IACA,iBAAA;IACA,WAAA;EAEJ;EADI;IACE,eAAA;EAGN;EAAE;IACE,aAAA;IACA,2BAAA;IACA,UAAA;IACA,aAAA;EAEJ;EAAE;IACE,cAAA;IACA,eAAA;IACA,WAAA;IACA,SAAA;IACA,iBAAA;IACA,eAAA;IACA,WAAA;IACA,uBAAA;IACA,aAAA;EAEJ;EAAE;IACE,cAAA;IACA,cAAA;IACA,uBAAA;IACA,qBAAA;IACA,oBAAA;EAEJ;EADI;IACE,aAAA;EAGN;EAFM;IACE,mBAAA;IACA,wBAAA;EAIR;EAFM;IACE,yBAAA;EAIR;AACF","sourcesContent":["$font-family: 'Thasadith', sans-serif;\n\n$fwb: 700;\n$fwr: 400;\n\n$default-color: black;\n$color-text: #fff;\n$color-text-black: #0b0a0a;\n$color-btn: linear-gradient(180deg, rgba(148, 146, 141, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n$color-square: rgba(61, 61, 61, 0.8);\n\n%btn-light {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n}\n\n%popup-btn-light {\n  font-size: 3.5rem;\n  line-height: 140%;\n  border: none;\n  background: linear-gradient(180deg, rgba(35, 34, 30, 0.59) 0%, rgba(255, 255, 249, 0.00) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n}\n","@import '../../../style/variables.scss';\n\n.header {\n  background: rgba(20, 19, 17, 0.5);\n  backdrop-filter: blur(0.6rem);\n  &_nav {\n    padding: 1.5rem 0rem;\n  }\n  &_list {\n    display: flex;\n    justify-content: center;\n    list-style: none;\n    padding: 0;\n    margin: 0;\n  }\n  &_list_item {\n    user-select: none;\n  }\n  &_item_btn {\n    @extend %btn-light;\n    background: $color-btn;\n    width: 15rem;\n    box-shadow: 0px 10px 4px 0px rgba(0, 0, 0, 0.25);\n    transition: 0.2s linear;\n    &:disabled {\n      opacity: 0.3;\n      cursor: not-allowed;\n    }\n    &:hover {\n      background: orange;\n    }\n    &:active {\n      background: linear-gradient(180deg, rgba(124, 121, 112, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n    }\n  }\n  &_item_btn_active {\n    background: orange;\n  }\n  &_list_item:not(:last-child) {\n    margin-right: 2rem;\n  }\n  &_item_link {\n    color: $default-color;\n    text-decoration: none;\n  }\n  &_burger {\n    display: none;\n  }\n}\n\n@media (max-width: 870px) {\n  .header {\n    &_item_btn {\n      width: 12rem;\n    }\n  }\n}\n\n@media (max-width: 670px) {\n  .header {\n    &_item_btn {\n      font-size: 2.1rem;\n      width: 10.5rem;\n    }\n  }\n}\n\n@media (max-width: 570px) {\n  .header {\n    height: 7rem;\n    &_nav {\n      padding: 0;\n    }\n    &_list {\n      height: 100vh;\n      position: fixed;\n      display: none;\n      flex-direction: column;\n      align-items: center;\n      opacity: 0;\n      transform: translateY(-500rem);\n      transition: linear 0.5s;\n      z-index: -1;\n      background: black;\n      width: 100%;\n      &_item:not(:last-child) {\n        margin-right: 0;\n      }\n    }\n    &_list_show {\n      display: flex;\n      transform: translateY(0rem);\n      opacity: 1;\n      z-index: 1002;\n    }\n    &_burger {\n      display: block;\n      position: fixed;\n      right: 2rem;\n      top: 1rem;\n      padding-top: 2rem;\n      cursor: pointer;\n      width: 4rem;\n      transition: linear 0.2s;\n      z-index: 1002;\n    }\n    &_burger_item {\n      display: block;\n      height: 0.4rem;\n      background-color: beige;\n      margin-bottom: 0.5rem;\n      transition: all 0.5s;\n      &_rotate {\n        z-index: 1003;\n        &:nth-child(1) {\n          margin-bottom: -3px;\n          transform: rotate(45deg);\n        }\n        &:nth-child(2) {\n          transform: rotate(-45deg);\n        }\n      }\n    }\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".main_counters {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-top: 2rem;\n}\n.main_counters_moves {\n  display: flex;\n  align-items: center;\n  user-select: none;\n  position: relative;\n  z-index: 1;\n  width: 18.5rem;\n}\n.main_counters_text {\n  margin-right: 0.5rem;\n}\n.main_counters_time {\n  display: flex;\n  align-items: center;\n  user-select: none;\n  position: relative;\n  z-index: 1;\n  width: 24rem;\n}\n.main_counters_time_text {\n  margin-right: 0.5rem;\n}\n.main_counters_time_number {\n  margin: 0;\n}\n.main_counters_txt {\n  font-size: 3.7rem;\n  line-height: 140%;\n  color: #0b0a0a;\n  margin: 0;\n}\n\n@media (max-width: 1920px) and (max-height: 1000px) {\n  .main_counters {\n    max-width: 57rem;\n    margin-left: 3.7rem;\n  }\n}\n@media (max-width: 870px) {\n  .main_counters {\n    max-width: 55rem;\n    margin-top: 5rem;\n  }\n  .main_counters_txt {\n    font-size: 2.9rem;\n  }\n  .main_counters_time {\n    max-width: 20rem;\n    width: 100%;\n  }\n}\n@media (max-width: 670px) {\n  .main_counters {\n    max-width: 50rem;\n  }\n}", "",{"version":3,"sources":["webpack://./src/ts/components/main/counters/counter.scss","webpack://./src/style/variables.scss"],"names":[],"mappings":"AAEA;EACE,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,gBAAA;AADF;AAEE;EACE,aAAA;EACA,mBAAA;EACA,iBAAA;EACA,kBAAA;EACA,UAAA;EACA,cAAA;AAAJ;AAEE;EACE,oBAAA;AAAJ;AAEE;EACE,aAAA;EACA,mBAAA;EACA,iBAAA;EACA,kBAAA;EACA,UAAA;EACA,YAAA;AAAJ;AAEE;EACE,oBAAA;AAAJ;AAEE;EACE,SAAA;AAAJ;AAEE;EACE,iBAAA;EACA,iBAAA;EACA,cC5Be;ED6Bf,SAAA;AAAJ;;AAIA;EACE;IACE,gBAAA;IACA,mBAAA;EADF;AACF;AAIA;EACE;IACE,gBAAA;IACA,gBAAA;EAFF;EAGE;IACE,iBAAA;EADJ;EAGE;IACE,gBAAA;IACA,WAAA;EADJ;AACF;AAKA;EACE;IACE,gBAAA;EAHF;AACF","sourcesContent":["@import '../../../../style/variables.scss';\n\n.main_counters {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-top: 2rem;\n  &_moves {\n    display: flex;\n    align-items: center;\n    user-select: none;\n    position: relative;\n    z-index: 1;\n    width: 18.5rem;\n  }\n  &_text {\n    margin-right: 0.5rem;\n  }\n  &_time {\n    display: flex;\n    align-items: center;\n    user-select: none;\n    position: relative;\n    z-index: 1;\n    width: 24rem;\n  }\n  &_time_text {\n    margin-right: 0.5rem;\n  }\n  &_time_number {\n    margin: 0;\n  }\n  &_txt {\n    font-size: 3.7rem;\n    line-height: 140%;\n    color: $color-text-black;\n    margin: 0;\n  }\n}\n\n@media (max-width: 1920px) and (max-height: 1000px) {\n  .main_counters {\n    max-width: 57rem;\n    margin-left: 3.7rem;\n  }\n}\n\n@media (max-width: 870px) {\n  .main_counters {\n    max-width: 55rem;\n    margin-top: 5rem;\n    &_txt {\n      font-size: 2.9rem;\n    }\n    &_time {\n      max-width: 20rem;\n      width: 100%;\n    }\n  }\n}\n\n@media (max-width: 670px) {\n  .main_counters {\n    max-width: 50rem;\n  }\n}\n","$font-family: 'Thasadith', sans-serif;\n\n$fwb: 700;\n$fwr: 400;\n\n$default-color: black;\n$color-text: #fff;\n$color-text-black: #0b0a0a;\n$color-btn: linear-gradient(180deg, rgba(148, 146, 141, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n$color-square: rgba(61, 61, 61, 0.8);\n\n%btn-light {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n}\n\n%popup-btn-light {\n  font-size: 3.5rem;\n  line-height: 140%;\n  border: none;\n  background: linear-gradient(180deg, rgba(35, 34, 30, 0.59) 0%, rgba(255, 255, 249, 0.00) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".main_frame_btn {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: #fff;\n  cursor: pointer;\n  user-select: none;\n}\n\n.main_frame {\n  display: flex;\n  flex-direction: column;\n  text-align: center;\n  align-items: center;\n  margin-top: 3.8rem;\n}\n.main_frame_block {\n  display: flex;\n  align-items: center;\n  user-select: none;\n}\n.main_frame_text {\n  margin: 0;\n}\n.main_frame_size {\n  margin: 0;\n  margin-left: 1rem;\n}\n.main_frame_other {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  margin-top: 3rem;\n  user-select: none;\n  width: 100%;\n}\n.main_frame_other_text {\n  margin: 0;\n}\n.main_frame_other_size {\n  font-size: 2.5rem;\n  line-height: 140%;\n  color: #fff;\n  width: 10.5rem;\n  background: linear-gradient(180deg, rgba(95, 105, 89, 0.49) 0%, #c2c3b7 100%);\n  box-shadow: 0px 10px 4px 0px rgba(0, 0, 0, 0.25);\n  backdrop-filter: blur(10px);\n  border: none;\n  transition: 0.2s linear;\n  cursor: pointer;\n}\n.main_frame_other_size:not(:last-child) {\n  margin-right: 0.4rem;\n}\n.main_frame_other_size:disabled {\n  opacity: 0.3;\n  cursor: not-allowed;\n}\n.main_frame_other_size:hover {\n  background: orange;\n}\n.main_frame_other_size:active {\n  background: linear-gradient(180deg, rgba(115, 136, 103, 0.49) 0%, #c2c3b7 100%);\n}\n.main_frame_other_size_active {\n  background: orange;\n}\n.main_frame_btn {\n  width: 20rem;\n  background: linear-gradient(180deg, rgba(95, 105, 89, 0.49) 0%, #c2c3b7 100%);\n  box-shadow: 0px 10px 4px 0px rgba(0, 0, 0, 0.25);\n  backdrop-filter: blur(10px);\n  transition: 0.2s linear;\n}\n.main_frame_btn:hover {\n  background: orange;\n}\n.main_frame_btn:disabled {\n  opacity: 0.3;\n  cursor: not-allowed;\n}\n.main_frame_btn:active {\n  background: linear-gradient(180deg, rgba(115, 136, 103, 0.49) 0%, #c2c3b7 100%);\n}\n.main_frame_btn_active {\n  background: orange;\n}\n\n@media (max-width: 870px) {\n  .main_frame {\n    max-width: 55rem;\n    margin-top: 2rem;\n  }\n}\n@media (max-width: 670px) {\n  .main_frame {\n    max-width: 50rem;\n    margin-top: 4rem;\n  }\n  .main_frame_other_size {\n    font-size: 2.1rem;\n  }\n}", "",{"version":3,"sources":["webpack://./src/style/variables.scss","webpack://./src/ts/components/main/frame-size/frame-size.scss"],"names":[],"mappings":"AAWA;EACE,iBAAA;EACA,iBAAA;EACA,YAAA;EACA,WATW;EAUX,eAAA;EACA,iBAAA;ACVF;;AALA;EACE,aAAA;EACA,sBAAA;EACA,kBAAA;EACA,mBAAA;EACA,kBAAA;AAQF;AAPE;EACE,aAAA;EACA,mBAAA;EACA,iBAAA;AASJ;AAPE;EACE,SAAA;AASJ;AAPE;EACE,SAAA;EACA,iBAAA;AASJ;AAPE;EACE,aAAA;EACA,mBAAA;EACA,uBAAA;EACA,gBAAA;EACA,iBAAA;EACA,WAAA;AASJ;AAPE;EACE,SAAA;AASJ;AAPE;EACE,iBAAA;EACA,iBAAA;EACA,WD5BS;EC6BT,cAAA;EACA,6EAAA;EACA,gDAAA;EACA,2BAAA;EACA,YAAA;EACA,uBAAA;EACA,eAAA;AASJ;AARI;EACE,oBAAA;AAUN;AARI;EACE,YAAA;EACA,mBAAA;AAUN;AARI;EACE,kBAAA;AAUN;AARI;EACE,+EAAA;AAUN;AAPE;EACE,kBAAA;AASJ;AAPE;EAEE,YAAA;EACA,6EAAA;EACA,gDAAA;EACA,2BAAA;EACA,uBAAA;AAQJ;AAPI;EACE,kBAAA;AASN;AAPI;EACE,YAAA;EACA,mBAAA;AASN;AAPI;EACE,+EAAA;AASN;AANE;EACE,kBAAA;AAQJ;;AAJA;EACE;IACE,gBAAA;IACA,gBAAA;EAOF;AACF;AAJA;EACE;IACE,gBAAA;IACA,gBAAA;EAMF;EALE;IACE,iBAAA;EAOJ;AACF","sourcesContent":["$font-family: 'Thasadith', sans-serif;\n\n$fwb: 700;\n$fwr: 400;\n\n$default-color: black;\n$color-text: #fff;\n$color-text-black: #0b0a0a;\n$color-btn: linear-gradient(180deg, rgba(148, 146, 141, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n$color-square: rgba(61, 61, 61, 0.8);\n\n%btn-light {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n}\n\n%popup-btn-light {\n  font-size: 3.5rem;\n  line-height: 140%;\n  border: none;\n  background: linear-gradient(180deg, rgba(35, 34, 30, 0.59) 0%, rgba(255, 255, 249, 0.00) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n}\n","@import '../../../../style/variables.scss';\n\n.main_frame {\n  display: flex;\n  flex-direction: column;\n  text-align: center;\n  align-items: center;\n  margin-top: 3.8rem;\n  &_block {\n    display: flex;\n    align-items: center;\n    user-select: none;\n  }\n  &_text {\n    margin: 0;\n  }\n  &_size {\n    margin: 0;\n    margin-left: 1rem;\n  }\n  &_other {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    margin-top: 3rem;\n    user-select: none;\n    width: 100%;\n  }\n  &_other_text {\n    margin: 0;\n  }\n  &_other_size {\n    font-size: 2.5rem;\n    line-height: 140%;\n    color: $color-text;\n    width: 10.5rem;\n    background: linear-gradient(180deg, rgba(95, 105, 89, 0.49) 0%, #c2c3b7 100%);\n    box-shadow: 0px 10px 4px 0px rgba(0, 0, 0, 0.25);\n    backdrop-filter: blur(10px);\n    border: none;\n    transition: 0.2s linear;\n    cursor: pointer;\n    &:not(:last-child) {\n      margin-right: 0.4rem;\n    }\n    &:disabled {\n      opacity: 0.3;\n      cursor: not-allowed;\n    }\n    &:hover {\n      background: orange;\n    }\n    &:active {\n      background: linear-gradient(180deg, rgba(115, 136, 103, 0.49) 0%, #c2c3b7 100%);\n    }\n  }\n  &_other_size_active {\n    background: orange;\n  }\n  &_btn {\n    @extend %btn-light;\n    width: 20rem;\n    background: linear-gradient(180deg, rgba(95, 105, 89, 0.49) 0%, #c2c3b7 100%);\n    box-shadow: 0px 10px 4px 0px rgba(0, 0, 0, 0.25);\n    backdrop-filter: blur(10px);\n    transition: 0.2s linear;\n    &:hover {\n      background: orange;\n    }\n    &:disabled {\n      opacity: 0.3;\n      cursor: not-allowed;\n    }\n    &:active {\n      background: linear-gradient(180deg, rgba(115, 136, 103, 0.49) 0%, #c2c3b7 100%);\n    }\n  }\n  &_btn_active {\n    background: orange;\n  }\n}\n\n@media (max-width: 870px) {\n  .main_frame {\n    max-width: 55rem;\n    margin-top: 2rem;\n  }\n}\n\n@media (max-width: 670px) {\n  .main_frame {\n    max-width: 50rem;\n    margin-top: 4rem;\n    &_other_size {\n      font-size: 2.1rem;\n    }\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".main {\n  max-width: 120rem;\n  padding: 0 1.5rem;\n  margin: 0 auto;\n  flex-grow: 1;\n}", "",{"version":3,"sources":["webpack://./src/ts/components/main/main.scss"],"names":[],"mappings":"AAAA;EACE,iBAAA;EACA,iBAAA;EACA,cAAA;EACA,YAAA;AACF","sourcesContent":[".main {\n  max-width: 120rem;\n  padding: 0 1.5rem;\n  margin: 0 auto;\n  flex-grow: 1;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".popups_new_btn {\n  font-size: 3.5rem;\n  line-height: 140%;\n  border: none;\n  background: linear-gradient(180deg, rgba(35, 34, 30, 0.59) 0%, rgba(255, 255, 249, 0) 100%);\n  color: #fff;\n  cursor: pointer;\n  user-select: none;\n}\n\n.popups {\n  position: absolute;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  top: 0;\n  background: rgba(0, 0, 0, 0.9);\n  z-index: 1000;\n}\n.popups_inner {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  position: absolute;\n  left: 50%;\n  top: 50%;\n  transform: translate(-50%, -50%);\n  padding: 1rem;\n  max-width: 90rem;\n  width: 100%;\n  min-height: 64rem;\n  border: 0.5rem solid #7e7d7b;\n}\n.popups_close_btn {\n  background: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ") no-repeat center/contain;\n  position: absolute;\n  right: 2rem;\n  top: 3rem;\n  width: 4rem;\n  height: 4rem;\n  cursor: pointer;\n  border: none;\n  transition: 0.2s linear;\n}\n.popups_close_btn:hover {\n  transform: translate(0.9);\n  opacity: 0.8;\n}\n.popups_new_btn {\n  position: absolute;\n  bottom: 0rem;\n  width: 100%;\n  transition: 0.2s linear;\n}\n.popups_new_btn:hover {\n  opacity: 0.5;\n  background: orange;\n}\n.popups_new_btn:active {\n  background: linear-gradient(180deg, rgba(124, 121, 112, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n}", "",{"version":3,"sources":["webpack://./src/style/variables.scss","webpack://./src/ts/components/main/popups/popups.scss"],"names":[],"mappings":"AAoBA;EACE,iBAAA;EACA,iBAAA;EACA,YAAA;EACA,2FAAA;EACA,WAnBW;EAoBX,eAAA;EACA,iBAAA;ACnBF;;AANA;EACE,kBAAA;EACA,OAAA;EACA,QAAA;EACA,SAAA;EACA,MAAA;EACA,8BAAA;EACA,aAAA;AASF;AARE;EACE,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,kBAAA;EACA,SAAA;EACA,QAAA;EACA,gCAAA;EACA,aAAA;EACA,gBAAA;EACA,WAAA;EACA,iBAAA;EACA,4BAAA;AAUJ;AARE;EACE,4EAAA;EACA,kBAAA;EACA,WAAA;EACA,SAAA;EACA,WAAA;EACA,YAAA;EACA,eAAA;EACA,YAAA;EACA,uBAAA;AAUJ;AATI;EACE,yBAAA;EACA,YAAA;AAWN;AARE;EAEE,kBAAA;EACA,YAAA;EACA,WAAA;EACA,uBAAA;AASJ;AARI;EACE,YAAA;EACA,kBAAA;AAUN;AARI;EACE,iGAAA;AAUN","sourcesContent":["$font-family: 'Thasadith', sans-serif;\n\n$fwb: 700;\n$fwr: 400;\n\n$default-color: black;\n$color-text: #fff;\n$color-text-black: #0b0a0a;\n$color-btn: linear-gradient(180deg, rgba(148, 146, 141, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n$color-square: rgba(61, 61, 61, 0.8);\n\n%btn-light {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n}\n\n%popup-btn-light {\n  font-size: 3.5rem;\n  line-height: 140%;\n  border: none;\n  background: linear-gradient(180deg, rgba(35, 34, 30, 0.59) 0%, rgba(255, 255, 249, 0.00) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n}\n","@import '../../../../style/variables.scss';\n\n.popups {\n  position: absolute;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  top: 0;\n  background: rgba(0, 0, 0, 0.9);\n  z-index: 1000;\n  &_inner {\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    position: absolute;\n    left: 50%;\n    top: 50%;\n    transform: translate(-50%, -50%);\n    padding: 1rem;\n    max-width: 90rem;\n    width: 100%;\n    min-height: 64rem;\n    border: 0.5rem solid #7e7d7b;\n  }\n  &_close_btn {\n    background: url('../../../../assets/svg/close-btn.svg') no-repeat center/contain;\n    position: absolute;\n    right: 2rem;\n    top: 3rem;\n    width: 4rem;\n    height: 4rem;\n    cursor: pointer;\n    border: none;\n    transition: 0.2s linear;\n    &:hover {\n      transform: translate(0.9);\n      opacity: 0.8;\n    }\n  }\n  &_new_btn {\n    @extend %popup-btn-light;\n    position: absolute;\n    bottom: 0rem;\n    width: 100%;\n    transition: 0.2s linear;\n    &:hover {\n      opacity: 0.5;\n      background: orange;\n    }\n    &:active {\n      background: linear-gradient(180deg, rgba(124, 121, 112, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n    }\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_URL_REPLACEMENT_0___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_0___);
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".popups_result {\n  width: 100%;\n  height: 100%;\n  padding: 1rem;\n}\n.popups_result_title {\n  font-size: 4rem;\n  line-height: 140%;\n  text-align: center;\n  color: #fff;\n  margin: 0;\n  margin-bottom: 1rem;\n  text-shadow: 0px 0px 20px #fff, 0px 0px 2px #fff, 0px 0px 275.3099975586px #fff, 0px 0px 0px #fff, 0px 0px 0px #fff, 1px 1px 9px #fff;\n}\n.popups_result_list {\n  font-size: 2.4rem;\n  line-height: 140%;\n  padding: 0;\n  list-style: none;\n  color: #fff;\n  width: 100%;\n  margin: 0rem 0rem 4rem;\n}\n.popups_result_wrapper {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  list-style: none;\n  padding: 0;\n}\n.popups_result_item {\n  font-size: 3.5rem;\n  line-height: 140%;\n  color: white;\n}\n.popups_result_item:nth-child(2) {\n  max-width: 21.5rem;\n  width: 100%;\n}\n.popups_result_item:nth-child(3) {\n  max-width: 18.5rem;\n  width: 100%;\n}\n.popups_result_item:nth-child(4) {\n  max-width: 28rem;\n  width: 100%;\n}\n.popups_result_count {\n  max-width: 3rem;\n  width: 100%;\n}\n.popups_result_delete {\n  background: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ") no-repeat center/contain;\n  width: 4rem;\n  height: 4rem;\n  border: none;\n  cursor: pointer;\n  transition: 0.2s linear;\n}\n\n@media (max-width: 860px) {\n  .popups_result_item {\n    font-size: 3rem;\n  }\n  .popups_result_item:nth-child(2) {\n    max-width: 17rem;\n    width: 100%;\n  }\n  .popups_result_item:nth-child(3) {\n    max-width: 15rem;\n    width: 100%;\n  }\n  .popups_result_item:nth-child(4) {\n    max-width: 21rem;\n    width: 100%;\n  }\n  .popups_result_count {\n    max-width: 2rem;\n    width: 100%;\n  }\n}\n@media (max-width: 660px) {\n  .popups_result_item {\n    font-size: 2rem;\n  }\n  .popups_result_item:nth-child(2) {\n    max-width: 17rem;\n    width: 100%;\n  }\n  .popups_result_item:nth-child(3) {\n    max-width: 15rem;\n    width: 100%;\n  }\n  .popups_result_item:nth-child(4) {\n    max-width: 21rem;\n    width: 100%;\n  }\n  .popups_result_count {\n    max-width: 2rem;\n    width: 100%;\n  }\n}", "",{"version":3,"sources":["webpack://./src/ts/components/main/popups/result-popup/result-popup.scss","webpack://./src/style/variables.scss"],"names":[],"mappings":"AAEA;EACE,WAAA;EACA,YAAA;EACA,aAAA;AADF;AAEE;EACE,eAAA;EACA,iBAAA;EACA,kBAAA;EACA,WCJS;EDKT,SAAA;EACA,mBAAA;EACA,qIAAA;AAAJ;AAGE;EACE,iBAAA;EACA,iBAAA;EACA,UAAA;EACA,gBAAA;EACA,WCfS;EDgBT,WAAA;EACA,sBAAA;AADJ;AAGE;EACE,aAAA;EACA,mBAAA;EACA,8BAAA;EACA,gBAAA;EACA,UAAA;AADJ;AAGE;EACE,iBAAA;EACA,iBAAA;EACA,YAAA;AADJ;AAEI;EACE,kBAAA;EACA,WAAA;AAAN;AAEI;EACE,kBAAA;EACA,WAAA;AAAN;AAEI;EACE,gBAAA;EACA,WAAA;AAAN;AAGE;EACE,eAAA;EACA,WAAA;AADJ;AAGE;EACE,4EAAA;EACA,WAAA;EACA,YAAA;EACA,YAAA;EACA,eAAA;EACA,uBAAA;AADJ;;AAKA;EAEI;IACE,eAAA;EAHJ;EAII;IACE,gBAAA;IACA,WAAA;EAFN;EAII;IACE,gBAAA;IACA,WAAA;EAFN;EAII;IACE,gBAAA;IACA,WAAA;EAFN;EAKE;IACE,eAAA;IACA,WAAA;EAHJ;AACF;AAOA;EAEI;IACE,eAAA;EANJ;EAOI;IACE,gBAAA;IACA,WAAA;EALN;EAOI;IACE,gBAAA;IACA,WAAA;EALN;EAOI;IACE,gBAAA;IACA,WAAA;EALN;EAQE;IACE,eAAA;IACA,WAAA;EANJ;AACF","sourcesContent":["@import '../../../../../style/variables.scss';\n\n.popups_result {\n  width: 100%;\n  height: 100%;\n  padding: 1rem;\n  &_title {\n    font-size: 4rem;\n    line-height: 140%;\n    text-align: center;\n    color: $color-text;\n    margin: 0;\n    margin-bottom: 1rem;\n    text-shadow: 0px 0px 20px #fff, 0px 0px 2px #fff, 0px 0px 275.3099975586px #fff, 0px 0px 0px #fff, 0px 0px 0px #fff,\n      1px 1px 9px #fff;\n  }\n  &_list {\n    font-size: 2.4rem;\n    line-height: 140%;\n    padding: 0;\n    list-style: none;\n    color: $color-text;\n    width: 100%;\n    margin: 0rem 0rem 4rem;\n  }\n  &_wrapper {\n    display: flex;\n    align-items: center;\n    justify-content: space-between;\n    list-style: none;\n    padding: 0;\n  }\n  &_item {\n    font-size: 3.5rem;\n    line-height: 140%;\n    color: white;\n    &:nth-child(2) {\n      max-width: 21.5rem;\n      width: 100%;\n    }\n    &:nth-child(3) {\n      max-width: 18.5rem;\n      width: 100%;\n    }\n    &:nth-child(4) {\n      max-width: 28rem;\n      width: 100%;\n    }\n  }\n  &_count {\n    max-width: 3rem;\n    width: 100%;\n  }\n  &_delete {\n    background: url('../../../../../assets/svg/close-btn.svg') no-repeat center/contain;\n    width: 4rem;\n    height: 4rem;\n    border: none;\n    cursor: pointer;\n    transition: 0.2s linear;\n  }\n}\n\n@media (max-width: 860px) {\n  .popups_result {\n    &_item {\n      font-size: 3rem;\n      &:nth-child(2) {\n        max-width: 17rem;\n        width: 100%;\n      }\n      &:nth-child(3) {\n        max-width: 15rem;\n        width: 100%;\n      }\n      &:nth-child(4) {\n        max-width: 21rem;\n        width: 100%;\n      }\n    }\n    &_count {\n      max-width: 2rem;\n      width: 100%;\n    }\n  }\n}\n\n@media (max-width: 660px) {\n  .popups_result {\n    &_item {\n      font-size: 2rem;\n      &:nth-child(2) {\n        max-width: 17rem;\n        width: 100%;\n      }\n      &:nth-child(3) {\n        max-width: 15rem;\n        width: 100%;\n      }\n      &:nth-child(4) {\n        max-width: 21rem;\n        width: 100%;\n      }\n    }\n    &_count {\n      max-width: 2rem;\n      width: 100%;\n    }\n  }\n}\n","$font-family: 'Thasadith', sans-serif;\n\n$fwb: 700;\n$fwr: 400;\n\n$default-color: black;\n$color-text: #fff;\n$color-text-black: #0b0a0a;\n$color-btn: linear-gradient(180deg, rgba(148, 146, 141, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n$color-square: rgba(61, 61, 61, 0.8);\n\n%btn-light {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n}\n\n%popup-btn-light {\n  font-size: 3.5rem;\n  line-height: 140%;\n  border: none;\n  background: linear-gradient(180deg, rgba(35, 34, 30, 0.59) 0%, rgba(255, 255, 249, 0.00) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".warning_btn {\n  font-size: 3.5rem;\n  line-height: 140%;\n  border: none;\n  background: linear-gradient(180deg, rgba(35, 34, 30, 0.59) 0%, rgba(255, 255, 249, 0) 100%);\n  color: #fff;\n  cursor: pointer;\n  user-select: none;\n}\n\n.warning {\n  position: absolute;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  top: 0;\n  background: rgba(0, 0, 0, 0.9);\n  user-select: none;\n  z-index: 1001;\n}\n.warning_inner {\n  max-width: 90rem;\n  width: 100%;\n  padding: 1rem;\n  border: 0.5rem solid #7e7d7b;\n  background: linear-gradient(180deg, #1d1e1a 0%, rgba(55, 56, 52, 0) 100%);\n  position: absolute;\n  transform: translate(-50%, -50%);\n  left: 50%;\n  top: 50%;\n}\n.warning_text {\n  font-size: 6.5rem;\n  line-height: 140%;\n  text-align: center;\n  color: #fff;\n  margin: 0;\n  text-shadow: 0px 0px 20px #fff, 0px 0px 2px #fff, 0px 0px 275.3099975586px #fff, 0px 0px 0px #fff, 0px 0px 0px #fff, 1px 1px 9px #fff;\n}\n.warning_close {\n  position: absolute;\n  right: 2rem;\n  top: 1.5rem;\n  width: 4rem;\n  height: 4rem;\n  border: none;\n  cursor: pointer;\n  transition: 0.2s linear;\n}\n.warning_close:hover {\n  transform: translate(0.9);\n  opacity: 0.8;\n}\n.warning_btns {\n  display: flex;\n  justify-content: center;\n  margin-top: 5.6rem;\n  margin-bottom: 3.4rem;\n}\n.warning_btn {\n  font-size: 4.5rem;\n  text-transform: uppercase;\n  height: 8rem;\n  max-width: 30rem;\n  width: 100%;\n  transition: 0.2s linear;\n}\n.warning_btn:nth-child(1) {\n  margin-right: 8rem;\n}\n.warning_btn:hover {\n  opacity: 0.5;\n  background: orange;\n}\n.warning_btn:active {\n  background: linear-gradient(180deg, rgba(124, 121, 112, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n}", "",{"version":3,"sources":["webpack://./src/style/variables.scss","webpack://./src/ts/components/main/popups/warning-popup/warning-popup.scss"],"names":[],"mappings":"AAoBA;EACE,iBAAA;EACA,iBAAA;EACA,YAAA;EACA,2FAAA;EACA,WAnBW;EAoBX,eAAA;EACA,iBAAA;ACnBF;;AANA;EACE,kBAAA;EACA,OAAA;EACA,QAAA;EACA,SAAA;EACA,MAAA;EACA,8BAAA;EACA,iBAAA;EACA,aAAA;AASF;AARE;EACE,gBAAA;EACA,WAAA;EACA,aAAA;EACA,4BAAA;EACA,yEAAA;EACA,kBAAA;EACA,gCAAA;EACA,SAAA;EACA,QAAA;AAUJ;AARE;EACE,iBAAA;EACA,iBAAA;EACA,kBAAA;EACA,WDpBS;ECqBT,SAAA;EACA,qIAAA;AAUJ;AAPE;EACE,kBAAA;EACA,WAAA;EACA,WAAA;EACA,WAAA;EACA,YAAA;EACA,YAAA;EACA,eAAA;EACA,uBAAA;AASJ;AARI;EACE,yBAAA;EACA,YAAA;AAUN;AAPE;EACE,aAAA;EACA,uBAAA;EACA,kBAAA;EACA,qBAAA;AASJ;AAPE;EAEE,iBAAA;EACA,yBAAA;EACA,YAAA;EACA,gBAAA;EACA,WAAA;EACA,uBAAA;AAQJ;AAPI;EACE,kBAAA;AASN;AAPI;EACE,YAAA;EACA,kBAAA;AASN;AAPI;EACE,iGAAA;AASN","sourcesContent":["$font-family: 'Thasadith', sans-serif;\n\n$fwb: 700;\n$fwr: 400;\n\n$default-color: black;\n$color-text: #fff;\n$color-text-black: #0b0a0a;\n$color-btn: linear-gradient(180deg, rgba(148, 146, 141, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n$color-square: rgba(61, 61, 61, 0.8);\n\n%btn-light {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n}\n\n%popup-btn-light {\n  font-size: 3.5rem;\n  line-height: 140%;\n  border: none;\n  background: linear-gradient(180deg, rgba(35, 34, 30, 0.59) 0%, rgba(255, 255, 249, 0.00) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n}\n","@import '../../../../../style/variables.scss';\n\n.warning {\n  position: absolute;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  top: 0;\n  background: rgba(0, 0, 0, 0.9);\n  user-select: none;\n  z-index: 1001;\n  &_inner {\n    max-width: 90rem;\n    width: 100%;\n    padding: 1rem;\n    border: 0.5rem solid #7e7d7b;\n    background: linear-gradient(180deg, #1d1e1a 0%, rgba(55, 56, 52, 0) 100%);\n    position: absolute;\n    transform: translate(-50%, -50%);\n    left: 50%;\n    top: 50%;\n  }\n  &_text {\n    font-size: 6.5rem;\n    line-height: 140%;\n    text-align: center;\n    color: $color-text;\n    margin: 0;\n    text-shadow: 0px 0px 20px #fff, 0px 0px 2px #fff, 0px 0px 275.3099975586px #fff, 0px 0px 0px #fff, 0px 0px 0px #fff,\n      1px 1px 9px #fff;\n  }\n  &_close {\n    position: absolute;\n    right: 2rem;\n    top: 1.5rem;\n    width: 4rem;\n    height: 4rem;\n    border: none;\n    cursor: pointer;\n    transition: 0.2s linear;\n    &:hover {\n      transform: translate(0.9);\n      opacity: 0.8;\n    }\n  }\n  &_btns {\n    display: flex;\n    justify-content: center;\n    margin-top: 5.6rem;\n    margin-bottom: 3.4rem;\n  }\n  &_btn {\n    @extend %popup-btn-light;\n    font-size: 4.5rem;\n    text-transform: uppercase;\n    height: 8rem;\n    max-width: 30rem;\n    width: 100%;\n    transition: 0.2s linear;\n    &:nth-child(1) {\n      margin-right: 8rem;\n    }\n    &:hover {\n      opacity: 0.5;\n      background: orange;\n    }\n    &:active {\n      background: linear-gradient(180deg, rgba(124, 121, 112, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n    }\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/******/ })()
;
//# sourceMappingURL=bundle-1dcf1549c5fda6535201.js.map