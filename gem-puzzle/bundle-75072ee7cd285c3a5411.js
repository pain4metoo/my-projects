...
class App extends _common_control__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  changeFontFamily(isEn, parentNode) {
    isEn ? parentNode.style.fontFamily = `'Thasadith', sans-serif` : parentNode.style.fontFamily = `'Ubuntu', sans-serif`;
  }
}
    ...
    this.popupsListener = type => {
      switch (type) {
        ...
        case _common_state_types__WEBPACK_IMPORTED_MODULE_2__.StateOptions.showResultPopup:
          ...
          _common_local_storage__WEBPACK_IMPORTED_MODULE_8__.lStorage.get('results').length > 0 ? newGameBtn.node.disabled = false : newGameBtn.node.disabled = true;
          break;
...
var ___CSS_LOADER_URL_IMPORT_7___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/fonts/Ubuntu-Regular.eot */ "./src/assets/fonts/Ubuntu-Regular.eot"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_8___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/fonts/Ubuntu-Regular.woff */ "./src/assets/fonts/Ubuntu-Regular.woff"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_9___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/fonts/Ubuntu-Regular.ttf */ "./src/assets/fonts/Ubuntu-Regular.ttf"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_10___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/fonts/Ubuntu-Regular.woff2 */ "./src/assets/fonts/Ubuntu-Regular.woff2"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_11___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/fonts/Ubuntu-Bold.eot */ "./src/assets/fonts/Ubuntu-Bold.eot"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_12___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/fonts/Ubuntu-Bold.woff */ "./src/assets/fonts/Ubuntu-Bold.woff"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_13___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/fonts/Ubuntu-Bold.ttf */ "./src/assets/fonts/Ubuntu-Bold.ttf"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_14___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/image/main-bg-light.jpg */ "./src/assets/image/main-bg-light.jpg"), __webpack_require__.b);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header_item_btn, .header_mobile_btn {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: #fff;\n  cursor: pointer;\n  user-select: none;\n}\n.header_item_btn:hover, .header_mobile_btn:hover {\n  box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff, 0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n}\n.header_item_btn:active, .header_mobile_btn:active {\n  box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff, 0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n}\n\n.header {\n  background: rgba(20, 19, 17, 0.5);\n  backdrop-filter: blur(0.6rem);\n}\n.header_nav {\n  padding: 1.5rem 0rem;\n}\n.header_list {\n  display: flex;\n  justify-content: center;\n  list-style: none;\n  padding: 0;\n  margin: 0;\n}\n.header_list_item {\n  user-select: none;\n}\n.header_mobile_btn {\n  display: none;\n  background: linear-gradient(180deg, rgba(148, 146, 141, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n  width: 10rem;\n  box-shadow: 0px 10px 4px 0px rgba(0, 0, 0, 0.25);\n  transition: 0.2s linear;\n  margin-top: 1.5rem;\n  margin-left: 1.5rem;\n}\n.header_mobile_btn:disabled {\n  opacity: 0.3;\n  cursor: not-allowed;\n}\n.header_mobile_btn_active {\n  background: rgb(142, 122, 61);\n}\n.header_item_btn {\n  background: linear-gradient(180deg, rgba(148, 146, 141, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n  width: 15rem;\n  box-shadow: 0px 10px 4px 0px rgba(0, 0, 0, 0.25);\n  transition: 0.2s linear;\n}\n.header_item_btn:disabled {\n  opacity: 0.3;\n  cursor: not-allowed;\n}\n.header_item_btn_active {\n  background: rgb(142, 122, 61);\n}\n.header_list_item:not(:last-child) {\n  margin-right: 2rem;\n}\n.header_item_link {\n  color: black;\n  text-decoration: none;\n}\n.header_burger {\n  display: none;\n}\n\n@media (max-width: 870px) {\n  .header_item_btn {\n    width: 12rem;\n  }\n}\n@media (max-width: 670px) {\n  .header_item_btn {\n    font-size: 2.1rem;\n    width: 10.5rem;\n  }\n}\n@media (max-width: 570px) {\n  .header {\n    height: 7rem;\n  }\n  .header_mobile_btn {\n    display: block;\n    position: absolute;\n  }\n  .header_nav {\n    padding: 0;\n  }\n  .header_list {\n    height: 100vh;\n    position: fixed;\n    display: none;\n    flex-direction: column;\n    align-items: center;\n    justify-content: flex-start;\n    padding-top: 8rem;\n    opacity: 0;\n    transform: translateY(-500rem);\n    transition: linear 0.5s;\n    z-index: -1;\n    background: black;\n    width: 100%;\n  }\n  .header_list_item:not(:last-child) {\n    margin-right: 0;\n  }\n  .header_list_item:nth-child(2) {\n    display: none;\n  }\n  .header_list_item {\n    width: 100%;\n    height: 6rem;\n  }\n  .header_item_btn {\n    font-size: 2.5rem;\n    line-height: 140%;\n    width: 100%;\n    height: 100%;\n  }\n  .header_list_show {\n    display: flex;\n    transform: translateY(0rem);\n    opacity: 1;\n    z-index: 1002;\n  }\n  .header_burger {\n    display: block;\n    position: fixed;\n    right: 2rem;\n    top: 1rem;\n    padding-top: 2rem;\n    cursor: pointer;\n    width: 4rem;\n    transition: linear 0.2s;\n    z-index: 1002;\n  }\n  .header_burger_item {\n    display: block;\n    height: 0.4rem;\n    background-color: beige;\n    margin-bottom: 0.5rem;\n    transition: all 0.5s;\n  }\n  .header_burger_item_rotate {\n    z-index: 1003;\n  }\n  .header_burger_item_rotate:nth-child(1) {\n    margin-bottom: -3px;\n    transform: rotate(45deg);\n  }\n  .header_burger_item_rotate:nth-child(2) {\n    transform: rotate(-45deg);\n  }\n}", "",{"version":3,"sources":["webpack://./src/style/variables.scss","webpack://./src/ts/components/header/header.scss"],"names":[],"mappings":"AAWA;EACE,iBAAA;EACA,iBAAA;EACA,YAAA;EACA,WATW;EAUX,eAAA;EACA,iBAAA;ACVF;ADWE;EACE,mKAAA;ACTJ;ADYE;EACE,mKAAA;ACVJ;;AAXA;EACE,iCAAA;EACA,6BAAA;AAcF;AAbE;EACE,oBAAA;AAeJ;AAbE;EACE,aAAA;EACA,uBAAA;EACA,gBAAA;EACA,UAAA;EACA,SAAA;AAeJ;AAbE;EACE,iBAAA;AAeJ;AAbE;EACE,aAAA;EAEA,iGDbQ;ECcR,YAAA;EACA,gDAAA;EACA,uBAAA;EACA,kBAAA;EACA,mBAAA;AAcJ;AAbI;EACE,YAAA;EACA,mBAAA;AAeN;AAZE;EACE,6BAAA;AAcJ;AAZE;EAEE,iGD7BQ;EC8BR,YAAA;EACA,gDAAA;EACA,uBAAA;AAaJ;AAZI;EACE,YAAA;EACA,mBAAA;AAcN;AAXE;EACE,6BAAA;AAaJ;AAXE;EACE,kBAAA;AAaJ;AAXE;EACE,YDhDY;ECiDZ,qBAAA;AAaJ;AAXE;EACE,aAAA;AAaJ;;AATA;EAEI;IACE,YAAA;EAWJ;AACF;AAPA;EAEI;IACE,iBAAA;IACA,cAAA;EAQJ;AACF;AAJA;EACE;IACE,YAAA;EAMF;EALE;IACE,cAAA;IACA,kBAAA;EAOJ;EALE;IACE,UAAA;EAOJ;EALE;IACE,aAAA;IACA,eAAA;IACA,aAAA;IACA,sBAAA;IACA,mBAAA;IACA,2BAAA;IACA,iBAAA;IACA,UAAA;IACA,8BAAA;IACA,uBAAA;IACA,WAAA;IACA,iBAAA;IACA,WAAA;EAOJ;EANI;IACE,eAAA;EAQN;EANI;IACE,aAAA;EAQN;EALE;IACE,WAAA;IACA,YAAA;EAOJ;EALE;IACE,iBAAA;IACA,iBAAA;IACA,WAAA;IACA,YAAA;EAOJ;EALE;IACE,aAAA;IACA,2BAAA;IACA,UAAA;IACA,aAAA;EAOJ;EALE;IACE,cAAA;IACA,eAAA;IACA,WAAA;IACA,SAAA;IACA,iBAAA;IACA,eAAA;IACA,WAAA;IACA,uBAAA;IACA,aAAA;EAOJ;EALE;IACE,cAAA;IACA,cAAA;IACA,uBAAA;IACA,qBAAA;IACA,oBAAA;EAOJ;EANI;IACE,aAAA;EAQN;EAPM;IACE,mBAAA;IACA,wBAAA;EASR;EAPM;IACE,yBAAA;EASR;AACF","sourcesContent":["$font-family: 'Thasadith', sans-serif;\n\n$fwb: 700;\n$fwr: 400;\n\n$default-color: black;\n$color-text: #fff;\n$color-text-black: #0b0a0a;\n$color-btn: linear-gradient(180deg, rgba(148, 146, 141, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n$color-square: rgba(61, 61, 61, 0.8);\n\n%btn-light {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n}\n\n%popup-btn-light {\n  font-size: 3.5rem;\n  line-height: 140%;\n  border: none;\n  background: linear-gradient(180deg, #23221e 0%, rgba(255, 255, 249, 0) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n}\n","@import '../../../style/variables.scss';\n\n.header {\n  background: rgba(20, 19, 17, 0.5);\n  backdrop-filter: blur(0.6rem);\n  &_nav {\n    padding: 1.5rem 0rem;\n  }\n  &_list {\n    display: flex;\n    justify-content: center;\n    list-style: none;\n    padding: 0;\n    margin: 0;\n  }\n  &_list_item {\n    user-select: none;\n  }\n  &_mobile_btn {\n    display: none;\n    @extend %btn-light;\n    background: $color-btn;\n    width: 10rem;\n    box-shadow: 0px 10px 4px 0px rgba(0, 0, 0, 0.25);\n    transition: 0.2s linear;\n    margin-top: 1.5rem;\n    margin-left: 1.5rem;\n    &:disabled {\n      opacity: 0.3;\n      cursor: not-allowed;\n    }\n  }\n  &_mobile_btn_active {\n    background: rgb(142, 122, 61);\n  }\n  &_item_btn {\n    @extend %btn-light;\n    background: $color-btn;\n    width: 15rem;\n    box-shadow: 0px 10px 4px 0px rgba(0, 0, 0, 0.25);\n    transition: 0.2s linear;\n    &:disabled {\n      opacity: 0.3;\n      cursor: not-allowed;\n    }\n  }\n  &_item_btn_active {\n    background: rgb(142, 122, 61);\n  }\n  &_list_item:not(:last-child) {\n    margin-right: 2rem;\n  }\n  &_item_link {\n    color: $default-color;\n    text-decoration: none;\n  }\n  &_burger {\n    display: none;\n  }\n}\n\n@media (max-width: 870px) {\n  .header {\n    &_item_btn {\n      width: 12rem;\n    }\n  }\n}\n\n@media (max-width: 670px) {\n  .header {\n    &_item_btn {\n      font-size: 2.1rem;\n      width: 10.5rem;\n    }\n  }\n}\n\n@media (max-width: 570px) {\n  .header {\n    height: 7rem;\n    &_mobile_btn {\n      display: block;\n      position: absolute;\n    }\n    &_nav {\n      padding: 0;\n    }\n    &_list {\n      height: 100vh;\n      position: fixed;\n      display: none;\n      flex-direction: column;\n      align-items: center;\n      justify-content: flex-start;\n      padding-top: 8rem;\n      opacity: 0;\n      transform: translateY(-500rem);\n      transition: linear 0.5s;\n      z-index: -1;\n      background: black;\n      width: 100%;\n      &_item:not(:last-child) {\n        margin-right: 0;\n      }\n      &_item:nth-child(2) {\n        display: none;\n      }\n    }\n    &_list_item {\n      width: 100%;\n      height: 6rem;\n    }\n    &_item_btn {\n      font-size: 2.5rem;\n      line-height: 140%;\n      width: 100%;\n      height: 100%;\n    }\n    &_list_show {\n      display: flex;\n      transform: translateY(0rem);\n      opacity: 1;\n      z-index: 1002;\n    }\n    &_burger {\n      display: block;\n      position: fixed;\n      right: 2rem;\n      top: 1rem;\n      padding-top: 2rem;\n      cursor: pointer;\n      width: 4rem;\n      transition: linear 0.2s;\n      z-index: 1002;\n    }\n    &_burger_item {\n      display: block;\n      height: 0.4rem;\n      background-color: beige;\n      margin-bottom: 0.5rem;\n      transition: all 0.5s;\n      &_rotate {\n        z-index: 1003;\n        &:nth-child(1) {\n          margin-bottom: -3px;\n          transform: rotate(45deg);\n        }\n        &:nth-child(2) {\n          transform: rotate(-45deg);\n        }\n      }\n    }\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".main_counters {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-top: 2rem;\n}\n.main_counters_moves {\n  display: flex;\n  align-items: center;\n  user-select: none;\n  position: relative;\n  z-index: 1;\n  width: 18.5rem;\n}\n.main_counters_text {\n  margin-right: 0.5rem;\n}\n.main_counters_time {\n  display: flex;\n  align-items: center;\n  user-select: none;\n  position: relative;\n  z-index: 1;\n}\n.main_counters_time_text {\n  margin-right: 0.5rem;\n}\n.main_counters_time_number {\n  margin: 0;\n}\n.main_counters_txt {\n  font-size: 3.7rem;\n  line-height: 140%;\n  color: #0b0a0a;\n  margin: 0;\n}\n\n@media (max-width: 1920px) and (max-height: 1000px) {\n  .main_counters {\n    max-width: 57rem;\n    margin-left: 3.7rem;\n  }\n}\n@media (max-width: 870px) {\n  .main_counters {\n    max-width: 55rem;\n  }\n  .main_counters_txt {\n    font-size: 2.9rem;\n  }\n  .main_counters_time {\n    max-width: 20rem;\n    width: 100%;\n  }\n}\n@media (max-width: 670px) {\n  .main_counters {\n    max-width: 50rem;\n  }\n}\n@media (max-width: 450px) {\n  .main_counters {\n    margin: 0;\n  }\n  .main_counters_moves {\n    width: 100%;\n  }\n  .main_counters_time {\n    width: 100%;\n  }\n  .main_counters_txt {\n    font-size: 2.1rem;\n  }\n}", "",{"version":3,"sources":["webpack://./src/ts/components/main/counters/counter.scss","webpack://./src/style/variables.scss"],"names":[],"mappings":"AAEA;EACE,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,gBAAA;AADF;AAEE;EACE,aAAA;EACA,mBAAA;EACA,iBAAA;EACA,kBAAA;EACA,UAAA;EACA,cAAA;AAAJ;AAEE;EACE,oBAAA;AAAJ;AAEE;EACE,aAAA;EACA,mBAAA;EACA,iBAAA;EACA,kBAAA;EACA,UAAA;AAAJ;AAEE;EACE,oBAAA;AAAJ;AAEE;EACE,SAAA;AAAJ;AAEE;EACE,iBAAA;EACA,iBAAA;EACA,cC3Be;ED4Bf,SAAA;AAAJ;;AAIA;EACE;IACE,gBAAA;IACA,mBAAA;EADF;AACF;AAIA;EACE;IACE,gBAAA;EAFF;EAGE;IACE,iBAAA;EADJ;EAGE;IACE,gBAAA;IACA,WAAA;EADJ;AACF;AAKA;EACE;IACE,gBAAA;EAHF;AACF;AAMA;EACE;IACE,SAAA;EAJF;EAKE;IACE,WAAA;EAHJ;EAKE;IACE,WAAA;EAHJ;EAKE;IACE,iBAAA;EAHJ;AACF","sourcesContent":["@import '../../../../style/variables.scss';\n\n.main_counters {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-top: 2rem;\n  &_moves {\n    display: flex;\n    align-items: center;\n    user-select: none;\n    position: relative;\n    z-index: 1;\n    width: 18.5rem;\n  }\n  &_text {\n    margin-right: 0.5rem;\n  }\n  &_time {\n    display: flex;\n    align-items: center;\n    user-select: none;\n    position: relative;\n    z-index: 1;\n  }\n  &_time_text {\n    margin-right: 0.5rem;\n  }\n  &_time_number {\n    margin: 0;\n  }\n  &_txt {\n    font-size: 3.7rem;\n    line-height: 140%;\n    color: $color-text-black;\n    margin: 0;\n  }\n}\n\n@media (max-width: 1920px) and (max-height: 1000px) {\n  .main_counters {\n    max-width: 57rem;\n    margin-left: 3.7rem;\n  }\n}\n\n@media (max-width: 870px) {\n  .main_counters {\n    max-width: 55rem;\n    &_txt {\n      font-size: 2.9rem;\n    }\n    &_time {\n      max-width: 20rem;\n      width: 100%;\n    }\n  }\n}\n\n@media (max-width: 670px) {\n  .main_counters {\n    max-width: 50rem;\n  }\n}\n\n@media (max-width: 450px) {\n  .main_counters {\n    margin: 0;\n    &_moves {\n      width: 100%;\n    }\n    &_time {\n      width: 100%;\n    }\n    &_txt {\n      font-size: 2.1rem;\n    }\n  }\n}\n","$font-family: 'Thasadith', sans-serif;\n\n$fwb: 700;\n$fwr: 400;\n\n$default-color: black;\n$color-text: #fff;\n$color-text-black: #0b0a0a;\n$color-btn: linear-gradient(180deg, rgba(148, 146, 141, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n$color-square: rgba(61, 61, 61, 0.8);\n\n%btn-light {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n}\n\n%popup-btn-light {\n  font-size: 3.5rem;\n  line-height: 140%;\n  border: none;\n  background: linear-gradient(180deg, #23221e 0%, rgba(255, 255, 249, 0) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".main_frame_btn, .main_frame_other_size {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: #fff;\n  cursor: pointer;\n  user-select: none;\n}\n.main_frame_btn:hover, .main_frame_other_size:hover {\n  box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff, 0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n}\n.main_frame_btn:active, .main_frame_other_size:active {\n  box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff, 0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n}\n\n.main_frame {\n  display: flex;\n  flex-direction: column;\n  text-align: center;\n  align-items: center;\n  margin-top: 3.8rem;\n}\n.main_frame_block {\n  display: flex;\n  align-items: center;\n  user-select: none;\n}\n.main_frame_text {\n  margin: 0;\n}\n.main_frame_size {\n  margin: 0;\n  margin-left: 1rem;\n}\n.main_frame_other {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  margin-top: 3rem;\n  user-select: none;\n  width: 100%;\n}\n.main_frame_other_text {\n  margin: 0;\n}\n.main_frame_other_size {\n  width: 10.5rem;\n  background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n  box-shadow: 0px 10px 4px 0px rgba(0, 0, 0, 0.25);\n  backdrop-filter: blur(10px);\n  transition: 0.2s linear;\n  cursor: pointer;\n}\n.main_frame_other_size:not(:last-child) {\n  margin-right: 0.4rem;\n}\n.main_frame_other_size:disabled {\n  opacity: 0.3;\n  cursor: not-allowed;\n}\n.main_frame_other_size_active {\n  background: rgb(142, 122, 61);\n}\n.main_frame_btn {\n  padding: 1rem 3rem;\n  background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n  box-shadow: 0px 10px 4px 0px rgba(0, 0, 0, 0.25);\n  backdrop-filter: blur(10px);\n  transition: 0.2s linear;\n}\n.main_frame_btn:disabled {\n  opacity: 0.3;\n  cursor: not-allowed;\n}\n.main_frame_btn_active {\n  background: rgb(142, 122, 61);\n}\n\n@media (max-width: 870px) {\n  .main_frame {\n    max-width: 55rem;\n    margin-top: 2rem;\n  }\n}\n@media (max-width: 670px) {\n  .main_frame {\n    max-width: 50rem;\n    margin-top: 4rem;\n  }\n  .main_frame_other_size {\n    font-size: 2.1rem;\n  }\n}\n@media (max-width: 570px) {\n  .main_frame {\n    max-width: inherit;\n    margin-top: 4rem;\n  }\n  .main_frame_other_size {\n    font-size: 2.1rem;\n  }\n}\n@media (max-width: 450px) {\n  .main_frame {\n    max-width: inherit;\n    margin-top: 4rem;\n  }\n  .main_frame_other_size {\n    font-size: 1.7rem;\n  }\n  .main_frame_btn {\n    font-size: 2.1rem;\n  }\n}", "",{"version":3,"sources":["webpack://./src/style/variables.scss","webpack://./src/ts/components/main/frame-size/frame-size.scss"],"names":[],"mappings":"AAWA;EACE,iBAAA;EACA,iBAAA;EACA,YAAA;EACA,WATW;EAUX,eAAA;EACA,iBAAA;ACVF;ADWE;EACE,mKAAA;ACTJ;ADYE;EACE,mKAAA;ACVJ;;AAXA;EACE,aAAA;EACA,sBAAA;EACA,kBAAA;EACA,mBAAA;EACA,kBAAA;AAcF;AAbE;EACE,aAAA;EACA,mBAAA;EACA,iBAAA;AAeJ;AAbE;EACE,SAAA;AAeJ;AAbE;EACE,SAAA;EACA,iBAAA;AAeJ;AAbE;EACE,aAAA;EACA,mBAAA;EACA,uBAAA;EACA,gBAAA;EACA,iBAAA;EACA,WAAA;AAeJ;AAbE;EACE,SAAA;AAeJ;AAbE;EAEE,cAAA;EACA,+EAAA;EACA,gDAAA;EACA,2BAAA;EACA,uBAAA;EACA,eAAA;AAcJ;AAbI;EACE,oBAAA;AAeN;AAbI;EACE,YAAA;EACA,mBAAA;AAeN;AAZE;EACE,6BAAA;AAcJ;AAZE;EAEE,kBAAA;EACA,+EAAA;EACA,gDAAA;EACA,2BAAA;EACA,uBAAA;AAaJ;AAZI;EACE,YAAA;EACA,mBAAA;AAcN;AAXE;EACE,6BAAA;AAaJ;;AATA;EACE;IACE,gBAAA;IACA,gBAAA;EAYF;AACF;AATA;EACE;IACE,gBAAA;IACA,gBAAA;EAWF;EAVE;IACE,iBAAA;EAYJ;AACF;AARA;EACE;IACE,kBAAA;IACA,gBAAA;EAUF;EATE;IACE,iBAAA;EAWJ;AACF;AAPA;EACE;IACE,kBAAA;IACA,gBAAA;EASF;EARE;IACE,iBAAA;EAUJ;EARE;IACE,iBAAA;EAUJ;AACF","sourcesContent":["$font-family: 'Thasadith', sans-serif;\n\n$fwb: 700;\n$fwr: 400;\n\n$default-color: black;\n$color-text: #fff;\n$color-text-black: #0b0a0a;\n$color-btn: linear-gradient(180deg, rgba(148, 146, 141, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n$color-square: rgba(61, 61, 61, 0.8);\n\n%btn-light {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n}\n\n%popup-btn-light {\n  font-size: 3.5rem;\n  line-height: 140%;\n  border: none;\n  background: linear-gradient(180deg, #23221e 0%, rgba(255, 255, 249, 0) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n}\n","@import '../../../../style/variables.scss';\n\n.main_frame {\n  display: flex;\n  flex-direction: column;\n  text-align: center;\n  align-items: center;\n  margin-top: 3.8rem;\n  &_block {\n    display: flex;\n    align-items: center;\n    user-select: none;\n  }\n  &_text {\n    margin: 0;\n  }\n  &_size {\n    margin: 0;\n    margin-left: 1rem;\n  }\n  &_other {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    margin-top: 3rem;\n    user-select: none;\n    width: 100%;\n  }\n  &_other_text {\n    margin: 0;\n  }\n  &_other_size {\n    @extend %btn-light;\n    width: 10.5rem;\n    background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n    box-shadow: 0px 10px 4px 0px rgba(0, 0, 0, 0.25);\n    backdrop-filter: blur(10px);\n    transition: 0.2s linear;\n    cursor: pointer;\n    &:not(:last-child) {\n      margin-right: 0.4rem;\n    }\n    &:disabled {\n      opacity: 0.3;\n      cursor: not-allowed;\n    }\n  }\n  &_other_size_active {\n    background: rgb(142, 122, 61);\n  }\n  &_btn {\n    @extend %btn-light;\n    padding: 1rem 3rem;\n    background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n    box-shadow: 0px 10px 4px 0px rgba(0, 0, 0, 0.25);\n    backdrop-filter: blur(10px);\n    transition: 0.2s linear;\n    &:disabled {\n      opacity: 0.3;\n      cursor: not-allowed;\n    }\n  }\n  &_btn_active {\n    background: rgb(142, 122, 61);\n  }\n}\n\n@media (max-width: 870px) {\n  .main_frame {\n    max-width: 55rem;\n    margin-top: 2rem;\n  }\n}\n\n@media (max-width: 670px) {\n  .main_frame {\n    max-width: 50rem;\n    margin-top: 4rem;\n    &_other_size {\n      font-size: 2.1rem;\n    }\n  }\n}\n\n@media (max-width: 570px) {\n  .main_frame {\n    max-width: inherit;\n    margin-top: 4rem;\n    &_other_size {\n      font-size: 2.1rem;\n    }\n  }\n}\n\n@media (max-width: 450px) {\n  .main_frame {\n    max-width: inherit;\n    margin-top: 4rem;\n    &_other_size {\n      font-size: 1.7rem;\n    }\n    &_btn {\n      font-size: 2.1rem;\n    }\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".popups_finish {\n  width: 100%;\n  height: 100%;\n  margin-top: 1.5rem;\n}\n.popups_finish_info {\n  margin-top: 4rem;\n}\n.popups_finish_title {\n  font-size: 3.5rem;\n  line-height: 140%;\n  text-align: center;\n  color: #fff;\n  margin: 0;\n  text-shadow: 0px 0px 20px #fff, 0px 0px 2px #fff, 0px 0px 275.3099975586px #fff, 0px 0px 0px #fff, 0px 0px 0px #fff, 1px 1px 9px #fff;\n}\n.popups_finish_time {\n  font-size: 2.4rem;\n  line-height: 140%;\n  text-align: center;\n  color: #fff;\n  margin: 0;\n  margin-bottom: 1rem;\n}\n.popups_finish_moves {\n  font-size: 2.4rem;\n  line-height: 140%;\n  text-align: center;\n  color: #fff;\n  margin: 0;\n  margin-bottom: 1rem;\n}", "",{"version":3,"sources":["webpack://./src/ts/components/main/popups/finish-popup/finish-popup.scss","webpack://./src/style/variables.scss"],"names":[],"mappings":"AAEA;EACE,WAAA;EACA,YAAA;EACA,kBAAA;AADF;AAEE;EACE,gBAAA;AAAJ;AAEE;EACE,iBAAA;EACA,iBAAA;EACA,kBAAA;EACA,WCPS;EDQT,SAAA;EACA,qIAAA;AAAJ;AAGE;EACE,iBAAA;EACA,iBAAA;EACA,kBAAA;EACA,WChBS;EDiBT,SAAA;EACA,mBAAA;AADJ;AAGE;EACE,iBAAA;EACA,iBAAA;EACA,kBAAA;EACA,WCxBS;EDyBT,SAAA;EACA,mBAAA;AADJ","sourcesContent":["@import '../../../../../style/variables.scss';\n\n.popups_finish {\n  width: 100%;\n  height: 100%;\n  margin-top: 1.5rem;\n  &_info {\n    margin-top: 4rem;\n  }\n  &_title {\n    font-size: 3.5rem;\n    line-height: 140%;\n    text-align: center;\n    color: $color-text;\n    margin: 0;\n    text-shadow: 0px 0px 20px #fff, 0px 0px 2px #fff, 0px 0px 275.3099975586px #fff, 0px 0px 0px #fff, 0px 0px 0px #fff,\n      1px 1px 9px #fff;\n  }\n  &_time {\n    font-size: 2.4rem;\n    line-height: 140%;\n    text-align: center;\n    color: $color-text;\n    margin: 0;\n    margin-bottom: 1rem;\n  }\n  &_moves {\n    font-size: 2.4rem;\n    line-height: 140%;\n    text-align: center;\n    color: $color-text;\n    margin: 0;\n    margin-bottom: 1rem;\n  }\n}\n","$font-family: 'Thasadith', sans-serif;\n\n$fwb: 700;\n$fwr: 400;\n\n$default-color: black;\n$color-text: #fff;\n$color-text-black: #0b0a0a;\n$color-btn: linear-gradient(180deg, rgba(148, 146, 141, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n$color-square: rgba(61, 61, 61, 0.8);\n\n%btn-light {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n}\n\n%popup-btn-light {\n  font-size: 3.5rem;\n  line-height: 140%;\n  border: none;\n  background: linear-gradient(180deg, #23221e 0%, rgba(255, 255, 249, 0) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".popups_new_btn {\n  font-size: 3.5rem;\n  line-height: 140%;\n  border: none;\n  background: linear-gradient(180deg, #23221e 0%, rgba(255, 255, 249, 0) 100%);\n  color: #fff;\n  cursor: pointer;\n  user-select: none;\n}\n.popups_new_btn:hover {\n  box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff, 0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n}\n.popups_new_btn:active {\n  box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff, 0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n}\n\n.popups {\n  position: absolute;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  top: 0;\n  background: rgba(0, 0, 0, 0.9);\n  z-index: 1000;\n}\n.popups_inner {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  position: absolute;\n  left: 50%;\n  top: 50%;\n  transform: translate(-50%, -50%);\n  max-width: 90rem;\n  width: 100%;\n  min-height: 60rem;\n  border: 0.5rem solid #7e7d7b;\n}\n.popups_close_btn {\n  background: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ") no-repeat center/contain;\n  position: absolute;\n  right: 2rem;\n  top: 3rem;\n  width: 4rem;\n  height: 4rem;\n  cursor: pointer;\n  border: none;\n  transition: 0.2s linear;\n}\n.popups_close_btn:hover {\n  box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff, 0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n}\n.popups_new_btn {\n  position: absolute;\n  bottom: 0rem;\n  width: 100%;\n  transition: 0.2s linear;\n}\n.popups_new_btn:hover {\n  box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff, 0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n}\n.popups_new_btn:active {\n  box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff, 0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n}\n.popups_new_btn:disabled {\n  background: #3d3d3d;\n  opacity: 0.3;\n  cursor: not-allowed;\n}\n\n@media (max-width: 540px) {\n  .popups_result_title {\n    font-size: 3rem;\n  }\n  .popups_close_btn {\n    width: 3rem;\n    height: 3rem;\n  }\n}", "",{"version":3,"sources":["webpack://./src/style/variables.scss","webpack://./src/ts/components/main/popups/popups.scss"],"names":[],"mappings":"AA4BA;EACE,iBAAA;EACA,iBAAA;EACA,YAAA;EACA,4EAAA;EACA,WA3BW;EA4BX,eAAA;EACA,iBAAA;AC3BF;AD4BE;EACE,mKAAA;AC1BJ;AD6BE;EACE,mKAAA;AC3BJ;;AAZA;EACE,kBAAA;EACA,OAAA;EACA,QAAA;EACA,SAAA;EACA,MAAA;EACA,8BAAA;EACA,aAAA;AAeF;AAdE;EACE,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,kBAAA;EACA,SAAA;EACA,QAAA;EACA,gCAAA;EACA,gBAAA;EACA,WAAA;EACA,iBAAA;EACA,4BAAA;AAgBJ;AAdE;EACE,4EAAA;EACA,kBAAA;EACA,WAAA;EACA,SAAA;EACA,WAAA;EACA,YAAA;EACA,eAAA;EACA,YAAA;EACA,uBAAA;AAgBJ;AAfI;EACE,mKAAA;AAiBN;AAbE;EAEE,kBAAA;EACA,YAAA;EACA,WAAA;EACA,uBAAA;AAcJ;AAbI;EACE,mKAAA;AAeN;AAZI;EACE,mKAAA;AAcN;AAXI;EACE,mBAAA;EACA,YAAA;EACA,mBAAA;AAaN;;AARA;EAEI;IACE,eAAA;EAUJ;EARE;IACE,WAAA;IACA,YAAA;EAUJ;AACF","sourcesContent":["$font-family: 'Thasadith', sans-serif;\n\n$fwb: 700;\n$fwr: 400;\n\n$default-color: black;\n$color-text: #fff;\n$color-text-black: #0b0a0a;\n$color-btn: linear-gradient(180deg, rgba(148, 146, 141, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n$color-square: rgba(61, 61, 61, 0.8);\n\n%btn-light {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n}\n\n%popup-btn-light {\n  font-size: 3.5rem;\n  line-height: 140%;\n  border: none;\n  background: linear-gradient(180deg, #23221e 0%, rgba(255, 255, 249, 0) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n}\n","@import '../../../../style/variables.scss';\n\n.popups {\n  position: absolute;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  top: 0;\n  background: rgba(0, 0, 0, 0.9);\n  z-index: 1000;\n  &_inner {\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    position: absolute;\n    left: 50%;\n    top: 50%;\n    transform: translate(-50%, -50%);\n    max-width: 90rem;\n    width: 100%;\n    min-height: 60rem;\n    border: 0.5rem solid #7e7d7b;\n  }\n  &_close_btn {\n    background: url('../../../../assets/svg/close-btn.svg') no-repeat center/contain;\n    position: absolute;\n    right: 2rem;\n    top: 3rem;\n    width: 4rem;\n    height: 4rem;\n    cursor: pointer;\n    border: none;\n    transition: 0.2s linear;\n    &:hover {\n      box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n        0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    }\n  }\n  &_new_btn {\n    @extend %popup-btn-light;\n    position: absolute;\n    bottom: 0rem;\n    width: 100%;\n    transition: 0.2s linear;\n    &:hover {\n      box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n        0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    }\n    &:active {\n      box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n        0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    }\n    &:disabled {\n      background: #3d3d3d;\n      opacity: 0.3;\n      cursor: not-allowed;\n    }\n  }\n}\n\n@media (max-width: 540px) {\n  .popups {\n    &_result_title {\n      font-size: 3rem;\n    }\n    &_close_btn {\n      width: 3rem;\n      height: 3rem;\n    }\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_URL_REPLACEMENT_0___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_0___);
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".popups_result {\n  width: 100%;\n  height: 100%;\n}\n.popups_result_title {\n  font-size: 4rem;\n  line-height: 140%;\n  text-align: center;\n  color: #fff;\n  text-shadow: 0px 0px 20px #fff, 0px 0px 2px #fff, 0px 0px 275.3099975586px #fff, 0px 0px 0px #fff, 0px 0px 0px #fff, 1px 1px 9px #fff;\n}\n.popups_result_table {\n  width: 100%;\n  height: 100%;\n  border-collapse: collapse;\n}\n.popups_result_thead {\n  height: 10rem;\n  border-bottom: 0.5rem solid #7f7e7c;\n}\n.popups_result_empty {\n  font-size: 5rem;\n  line-height: 140%;\n  color: #fff;\n  opacity: 0.3;\n  display: flex;\n  justify-content: center;\n}\n.popups_result_th {\n  font-size: 4rem;\n  line-height: 140%;\n}\n.popups_result_tr {\n  position: relative;\n  text-align: center;\n  color: #fff;\n  transition: linear 0.3s;\n}\n.popups_result_tr:hover:not(:first-child) {\n  background: #7f7e7c;\n  opacity: 0.5;\n}\n.popups_result_td {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: 0.2rem solid #7f7e7c;\n  z-index: 2;\n}\n.popups_result_td:nth-child(1) {\n  width: 7rem;\n  border-left: none;\n}\n.popups_result_td:nth-child(4) {\n  border-right: none;\n}\n.popups_result_list {\n  font-size: 2.4rem;\n  line-height: 140%;\n  padding: 0;\n  list-style: none;\n  color: #fff;\n  width: 100%;\n  margin: 0rem 0rem 4rem;\n}\n.popups_result_wrapper {\n  display: flex;\n  align-items: center;\n  list-style: none;\n  padding: 0;\n  background: linear-gradient(180deg, rgba(148, 146, 141, 0.11) 0%, rgba(255, 255, 255, 0.12) 100%);\n  margin-bottom: 1rem;\n  padding: 0.5rem;\n}\n.popups_result_item {\n  font-size: 3.5rem;\n  line-height: 140%;\n  color: white;\n}\n.popups_result_item:nth-child(2) {\n  max-width: 30rem;\n  width: 100%;\n}\n.popups_result_item:nth-child(3) {\n  max-width: 18.5rem;\n  width: 100%;\n}\n.popups_result_item:nth-child(4) {\n  max-width: 28rem;\n  width: 100%;\n}\n.popups_result_count {\n  max-width: 3rem;\n  width: 100%;\n}\n.popups_result_delete {\n  background: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ") no-repeat center/contain;\n  width: 4rem;\n  height: 4rem;\n  border-top: 0.2rem solid #7f7e7c;\n  border-bottom: 0.2rem solid #7f7e7c;\n  cursor: pointer;\n  transition: 0.2s linear;\n}\n.popups_result_delete:hover {\n  opacity: 0.5;\n}\n\n@media (max-width: 450px) {\n  .popups_result_td {\n    font-size: 1.6rem;\n  }\n}", "",{"version":3,"sources":["webpack://./src/ts/components/main/popups/result-popup/result-popup.scss","webpack://./src/style/variables.scss"],"names":[],"mappings":"AAEA;EACE,WAAA;EACA,YAAA;AADF;AAEE;EACE,eAAA;EACA,iBAAA;EACA,kBAAA;EACA,WCHS;EDIT,qIAAA;AAAJ;AAGE;EACE,WAAA;EACA,YAAA;EACA,yBAAA;AADJ;AAGE;EACE,aAAA;EACA,mCAAA;AADJ;AAGE;EACE,eAAA;EACA,iBAAA;EACA,WCnBS;EDoBT,YAAA;EACA,aAAA;EACA,uBAAA;AADJ;AAGE;EACE,eAAA;EACA,iBAAA;AADJ;AAGE;EACE,kBAAA;EACA,kBAAA;EACA,WC/BS;EDgCT,uBAAA;AADJ;AAEI;EACE,mBAAA;EACA,YAAA;AAAN;AAGE;EACE,iBAAA;EACA,iBAAA;EACA,4BAAA;EACA,UAAA;AADJ;AAEI;EACE,WAAA;EACA,iBAAA;AAAN;AAEI;EACE,kBAAA;AAAN;AAGE;EACE,iBAAA;EACA,iBAAA;EACA,UAAA;EACA,gBAAA;EACA,WCxDS;EDyDT,WAAA;EACA,sBAAA;AADJ;AAGE;EACE,aAAA;EACA,mBAAA;EACA,gBAAA;EACA,UAAA;EACA,iGAAA;EACA,mBAAA;EACA,eAAA;AADJ;AAGE;EACE,iBAAA;EACA,iBAAA;EACA,YAAA;AADJ;AAEI;EACE,gBAAA;EACA,WAAA;AAAN;AAEI;EACE,kBAAA;EACA,WAAA;AAAN;AAEI;EACE,gBAAA;EACA,WAAA;AAAN;AAGE;EACE,eAAA;EACA,WAAA;AADJ;AAGE;EACE,4EAAA;EACA,WAAA;EACA,YAAA;EACA,gCAAA;EACA,mCAAA;EACA,eAAA;EACA,uBAAA;AADJ;AAEI;EACE,YAAA;AAAN;;AAKA;EAEI;IACE,iBAAA;EAHJ;AACF","sourcesContent":["@import '../../../../../style/variables.scss';\n\n.popups_result {\n  width: 100%;\n  height: 100%;\n  &_title {\n    font-size: 4rem;\n    line-height: 140%;\n    text-align: center;\n    color: $color-text;\n    text-shadow: 0px 0px 20px #fff, 0px 0px 2px #fff, 0px 0px 275.3099975586px #fff, 0px 0px 0px #fff, 0px 0px 0px #fff,\n      1px 1px 9px #fff;\n  }\n  &_table {\n    width: 100%;\n    height: 100%;\n    border-collapse: collapse;\n  }\n  &_thead {\n    height: 10rem;\n    border-bottom: 0.5rem solid #7f7e7c;\n  }\n  &_empty {\n    font-size: 5rem;\n    line-height: 140%;\n    color: $color-text;\n    opacity: 0.3;\n    display: flex;\n    justify-content: center;\n  }\n  &_th {\n    font-size: 4rem;\n    line-height: 140%;\n  }\n  &_tr {\n    position: relative;\n    text-align: center;\n    color: $color-text;\n    transition: linear 0.3s;\n    &:hover:not(:first-child) {\n      background: #7f7e7c;\n      opacity: 0.5;\n    }\n  }\n  &_td {\n    font-size: 2.5rem;\n    line-height: 140%;\n    border: 0.2rem solid #7f7e7c;\n    z-index: 2;\n    &:nth-child(1) {\n      width: 7rem;\n      border-left: none;\n    }\n    &:nth-child(4) {\n      border-right: none;\n    }\n  }\n  &_list {\n    font-size: 2.4rem;\n    line-height: 140%;\n    padding: 0;\n    list-style: none;\n    color: $color-text;\n    width: 100%;\n    margin: 0rem 0rem 4rem;\n  }\n  &_wrapper {\n    display: flex;\n    align-items: center;\n    list-style: none;\n    padding: 0;\n    background: linear-gradient(180deg, rgba(148, 146, 141, 0.11) 0%, rgba(255, 255, 255, 0.12) 100%);\n    margin-bottom: 1rem;\n    padding: 0.5rem;\n  }\n  &_item {\n    font-size: 3.5rem;\n    line-height: 140%;\n    color: white;\n    &:nth-child(2) {\n      max-width: 30rem;\n      width: 100%;\n    }\n    &:nth-child(3) {\n      max-width: 18.5rem;\n      width: 100%;\n    }\n    &:nth-child(4) {\n      max-width: 28rem;\n      width: 100%;\n    }\n  }\n  &_count {\n    max-width: 3rem;\n    width: 100%;\n  }\n  &_delete {\n    background: url('../../../../../assets/svg/close-btn.svg') no-repeat center/contain;\n    width: 4rem;\n    height: 4rem;\n    border-top: 0.2rem solid #7f7e7c;\n    border-bottom: 0.2rem solid #7f7e7c;\n    cursor: pointer;\n    transition: 0.2s linear;\n    &:hover {\n      opacity: 0.5;\n    }\n  }\n}\n\n@media (max-width: 450px) {\n  .popups_result {\n    &_td {\n      font-size: 1.6rem;\n    }\n  }\n}\n","$font-family: 'Thasadith', sans-serif;\n\n$fwb: 700;\n$fwr: 400;\n\n$default-color: black;\n$color-text: #fff;\n$color-text-black: #0b0a0a;\n$color-btn: linear-gradient(180deg, rgba(148, 146, 141, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n$color-square: rgba(61, 61, 61, 0.8);\n\n%btn-light {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n}\n\n%popup-btn-light {\n  font-size: 3.5rem;\n  line-height: 140%;\n  border: none;\n  background: linear-gradient(180deg, #23221e 0%, rgba(255, 255, 249, 0) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".settings {\n  width: 80%;\n  margin-top: 2rem;\n}\n.settings_title {\n  font-size: 4rem;\n  line-height: 140%;\n  text-align: center;\n  color: #fff;\n  margin: 0;\n}\n.settings_inner {\n  display: flex;\n  justify-content: space-between;\n}\n.settings_right {\n  display: flex;\n  flex-direction: column;\n  align-items: flex-start;\n}\n.settings_left {\n  min-width: 20rem;\n}\n\n@media (max-width: 450px) {\n  .settings_right {\n    align-items: inherit;\n  }\n  .settings_inner {\n    flex-direction: column;\n  }\n}", "",{"version":3,"sources":["webpack://./src/ts/components/main/popups/settings-popup/settings-popup.scss","webpack://./src/style/variables.scss"],"names":[],"mappings":"AAEA;EACE,UAAA;EACA,gBAAA;AADF;AAEE;EACE,eAAA;EACA,iBAAA;EACA,kBAAA;EACA,WCHS;EDIT,SAAA;AAAJ;AAEE;EACE,aAAA;EACA,8BAAA;AAAJ;AAEE;EACE,aAAA;EACA,sBAAA;EACA,uBAAA;AAAJ;AAEE;EACE,gBAAA;AAAJ;;AAIA;EAEI;IACE,oBAAA;EAFJ;EAIE;IACE,sBAAA;EAFJ;AACF","sourcesContent":["@import '../../../../../assets/../style/variables.scss';\n\n.settings {\n  width: 80%;\n  margin-top: 2rem;\n  &_title {\n    font-size: 4rem;\n    line-height: 140%;\n    text-align: center;\n    color: $color-text;\n    margin: 0;\n  }\n  &_inner {\n    display: flex;\n    justify-content: space-between;\n  }\n  &_right {\n    display: flex;\n    flex-direction: column;\n    align-items: flex-start;\n  }\n  &_left {\n    min-width: 20rem;\n  }\n}\n\n@media (max-width: 450px) {\n  .settings {\n    &_right {\n      align-items: inherit;\n    }\n    &_inner {\n      flex-direction: column;\n    }\n  }\n}\n","$font-family: 'Thasadith', sans-serif;\n\n$fwb: 700;\n$fwr: 400;\n\n$default-color: black;\n$color-text: #fff;\n$color-text-black: #0b0a0a;\n$color-btn: linear-gradient(180deg, rgba(148, 146, 141, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n$color-square: rgba(61, 61, 61, 0.8);\n\n%btn-light {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n}\n\n%popup-btn-light {\n  font-size: 3.5rem;\n  line-height: 140%;\n  border: none;\n  background: linear-gradient(180deg, #23221e 0%, rgba(255, 255, 249, 0) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".switcher {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  margin-bottom: 1rem;\n}\n.switcher_title {\n  font-size: 3rem;\n  line-height: 140%;\n  text-align: center;\n  color: #fff;\n  margin: 0;\n}\n.switcher_inner {\n  display: flex;\n  align-items: center;\n  width: 100%;\n}\n.switcher_switch {\n  position: relative;\n  display: inline-block;\n  width: 12rem;\n  height: 6rem;\n  margin-right: 2.2rem;\n}\n.switcher_checkbox {\n  display: none;\n}\n.switcher_slider {\n  position: absolute;\n  cursor: pointer;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background: linear-gradient(180deg, rgba(35, 34, 30, 0.59) 0%, rgba(255, 255, 249, 0) 100%);\n  transition: 0.4s linear;\n}\n.switcher_slider::before {\n  position: absolute;\n  content: \"\";\n  height: 5rem;\n  width: 5rem;\n  left: 0.4rem;\n  bottom: 0.4rem;\n  background: linear-gradient(180deg, rgba(226, 226, 226, 0.54) 0%, #bcbcbc 100%);\n  transition: 0.4s linear;\n}\n.switcher_value {\n  font-size: 3rem;\n  line-height: 140%;\n  color: #fff;\n  width: 8rem;\n}\n\n.switcher_checkbox:checked + .switcher_slider {\n  background: #fff;\n  box-shadow: 0px 0px 6.54px 0px #fff, 0px 0px 13.08px 0px #fff, 0px 0px 45.78px 0px #fff, 0px 0px 91.56px 0px #fff, 0px 0px 156.96001px 0px #fff, 0px 0px 274.67999px 0px #fff;\n}\n\n.switcher_checkbox:focus + .switcher_slider {\n  box-shadow: 0 0 1px #2196f3;\n}\n\n.switcher_checkbox:checked + .switcher_slider::before {\n  transform: translateX(6rem);\n}\n\n@media (max-width: 670px) {\n  .switcher_switch {\n    width: 6rem;\n    height: 3rem;\n    margin-right: 1.2rem;\n  }\n  .switcher_slider::before {\n    height: 2.5rem;\n    width: 2.5rem;\n    left: 0.2rem;\n    bottom: 0.2rem;\n  }\n  .switcher_value {\n    margin-top: 1rem;\n    margin-bottom: 1rem;\n  }\n  .switcher_checkbox:checked + .switcher_slider::before {\n    transform: translateX(3rem);\n  }\n}\n@media (max-width: 450px) {\n  .switcher {\n    margin-bottom: 2rem;\n  }\n  .switcher:nth-child(1) {\n    margin-top: 2rem;\n  }\n}", "",{"version":3,"sources":["webpack://./src/ts/components/main/popups/settings-popup/swither/switcher.scss","webpack://./src/style/variables.scss"],"names":[],"mappings":"AAEA;EACE,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,mBAAA;AADF;AAEE;EACE,eAAA;EACA,iBAAA;EACA,kBAAA;EACA,WCLS;EDMT,SAAA;AAAJ;AAEE;EACE,aAAA;EACA,mBAAA;EACA,WAAA;AAAJ;AAEE;EACE,kBAAA;EACA,qBAAA;EACA,YAAA;EACA,YAAA;EACA,oBAAA;AAAJ;AAEE;EACE,aAAA;AAAJ;AAEE;EACE,kBAAA;EACA,eAAA;EACA,MAAA;EACA,OAAA;EACA,QAAA;EACA,SAAA;EACA,2FAAA;EACA,uBAAA;AAAJ;AACI;EACE,kBAAA;EACA,WAAA;EACA,YAAA;EACA,WAAA;EACA,YAAA;EACA,cAAA;EACA,+EAAA;EACA,uBAAA;AACN;AAEE;EACE,eAAA;EACA,iBAAA;EACA,WC9CS;ED+CT,WAAA;AAAJ;;AAIA;EACE,gBAAA;EACA,6KAAA;AADF;;AAIA;EACE,2BAAA;AADF;;AAGA;EACE,2BAAA;AAAF;;AAGA;EAEI;IACE,WAAA;IACA,YAAA;IACA,oBAAA;EADJ;EAII;IACE,cAAA;IACA,aAAA;IACA,YAAA;IACA,cAAA;EAFN;EAKE;IACE,gBAAA;IACA,mBAAA;EAHJ;EAKE;IACE,2BAAA;EAHJ;AACF;AAOA;EACE;IACE,mBAAA;EALF;EAME;IACE,gBAAA;EAJJ;AACF","sourcesContent":["@import '../../../../../../assets/../style/variables.scss';\n\n.switcher {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  margin-bottom: 1rem;\n  &_title {\n    font-size: 3rem;\n    line-height: 140%;\n    text-align: center;\n    color: $color-text;\n    margin: 0;\n  }\n  &_inner {\n    display: flex;\n    align-items: center;\n    width: 100%;\n  }\n  &_switch {\n    position: relative;\n    display: inline-block;\n    width: 12rem;\n    height: 6rem;\n    margin-right: 2.2rem;\n  }\n  &_checkbox {\n    display: none;\n  }\n  &_slider {\n    position: absolute;\n    cursor: pointer;\n    top: 0;\n    left: 0;\n    right: 0;\n    bottom: 0;\n    background: linear-gradient(180deg, rgba(35, 34, 30, 0.59) 0%, rgba(255, 255, 249, 0) 100%);\n    transition: 0.4s linear;\n    &::before {\n      position: absolute;\n      content: '';\n      height: 5rem;\n      width: 5rem;\n      left: 0.4rem;\n      bottom: 0.4rem;\n      background: linear-gradient(180deg, rgba(226, 226, 226, 0.54) 0%, #bcbcbc 100%);\n      transition: 0.4s linear;\n    }\n  }\n  &_value {\n    font-size: 3rem;\n    line-height: 140%;\n    color: $color-text;\n    width: 8rem;\n  }\n}\n\n.switcher_checkbox:checked + .switcher_slider {\n  background: #fff;\n  box-shadow: 0px 0px 6.54px 0px #fff, 0px 0px 13.08px 0px #fff, 0px 0px 45.78px 0px #fff, 0px 0px 91.56px 0px #fff,\n    0px 0px 156.96001px 0px #fff, 0px 0px 274.67999px 0px #fff;\n}\n.switcher_checkbox:focus + .switcher_slider {\n  box-shadow: 0 0 1px #2196f3;\n}\n.switcher_checkbox:checked + .switcher_slider::before {\n  transform: translateX(6rem);\n}\n\n@media (max-width: 670px) {\n  .switcher {\n    &_switch {\n      width: 6rem;\n      height: 3rem;\n      margin-right: 1.2rem;\n    }\n    &_slider {\n      &::before {\n        height: 2.5rem;\n        width: 2.5rem;\n        left: 0.2rem;\n        bottom: 0.2rem;\n      }\n    }\n    &_value {\n      margin-top: 1rem;\n      margin-bottom: 1rem;\n    }\n    &_checkbox:checked + .switcher_slider::before {\n      transform: translateX(3rem);\n    }\n  }\n}\n\n@media (max-width: 450px) {\n  .switcher{\n    margin-bottom: 2rem;\n    &:nth-child(1) {\n      margin-top: 2rem;\n    }\n  }\n}\n","$font-family: 'Thasadith', sans-serif;\n\n$fwb: 700;\n$fwr: 400;\n\n$default-color: black;\n$color-text: #fff;\n$color-text-black: #0b0a0a;\n$color-btn: linear-gradient(180deg, rgba(148, 146, 141, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n$color-square: rgba(61, 61, 61, 0.8);\n\n%btn-light {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n}\n\n%popup-btn-light {\n  font-size: 3.5rem;\n  line-height: 140%;\n  border: none;\n  background: linear-gradient(180deg, #23221e 0%, rgba(255, 255, 249, 0) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".warning_btn {\n  font-size: 3.5rem;\n  line-height: 140%;\n  border: none;\n  background: linear-gradient(180deg, #23221e 0%, rgba(255, 255, 249, 0) 100%);\n  color: #fff;\n  cursor: pointer;\n  user-select: none;\n}\n.warning_btn:hover {\n  box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff, 0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n}\n.warning_btn:active {\n  box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff, 0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n}\n\n.warning {\n  position: absolute;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  top: 0;\n  background: rgba(0, 0, 0, 0.9);\n  user-select: none;\n  z-index: 1001;\n}\n.warning_inner {\n  max-width: 63.5rem;\n  width: 100%;\n  min-height: 30rem;\n  padding: 1rem;\n  border: 5px solid #7e7d7b;\n  background: linear-gradient(180deg, #1d1e1a 0%, rgba(55, 56, 52, 0) 100%);\n  position: absolute;\n  transform: translate(-50%, -50%);\n  left: 50%;\n  top: 50%;\n}\n.warning_text {\n  font-size: 5rem;\n  line-height: 140%;\n  text-align: center;\n  color: #fff;\n  margin: 0;\n  margin-top: 5.7rem;\n  text-shadow: 0px 0px 30.9599990845px #fff, 0px 0px 61.9199981689px #fff, 0px 0px 216.7200012207px #fff, 0px 0px 433.4400024414px #fff, 0px 0px 743.0399780273px #fff, 0px 0px 1300.3199462891px #fff;\n}\n.warning_close {\n  position: absolute;\n  right: 2rem;\n  top: 1.5rem;\n  width: 4rem;\n  height: 4rem;\n  border: none;\n  cursor: pointer;\n  transition: 0.2s linear;\n}\n.warning_close:hover {\n  transform: translate(0.9);\n  opacity: 0.8;\n}\n.warning_btns {\n  display: flex;\n  justify-content: center;\n  margin-top: 5rem;\n  margin-bottom: 3.7rem;\n}\n.warning_btn {\n  font-size: 3.5rem;\n  line-height: 5.5rem;\n  text-transform: uppercase;\n  height: 5.5rem;\n  max-width: 20rem;\n  width: 100%;\n  transition: 0.2s linear;\n  background: linear-gradient(180deg, #23221e 0%, rgba(255, 255, 249, 0) 100%);\n}\n.warning_btn:nth-child(1) {\n  margin-right: 8rem;\n}\n\n@media (max-width: 400px) {\n  .warning_inner {\n    min-height: inherit;\n  }\n  .warning_text {\n    font-size: 4rem;\n    margin-top: 3rem;\n  }\n  .warning_btn {\n    font-size: 2.5rem;\n    line-height: 140%;\n  }\n  .warning_btn:nth-child(1) {\n    margin-right: 3rem;\n  }\n  .warning_btns {\n    margin-bottom: 0;\n  }\n}", "",{"version":3,"sources":["webpack://./src/style/variables.scss","webpack://./src/ts/components/main/popups/warning-popup/warning-popup.scss"],"names":[],"mappings":"AA4BA;EACE,iBAAA;EACA,iBAAA;EACA,YAAA;EACA,4EAAA;EACA,WA3BW;EA4BX,eAAA;EACA,iBAAA;AC3BF;AD4BE;EACE,mKAAA;AC1BJ;AD6BE;EACE,mKAAA;AC3BJ;;AAZA;EACE,kBAAA;EACA,OAAA;EACA,QAAA;EACA,SAAA;EACA,MAAA;EACA,8BAAA;EACA,iBAAA;EACA,aAAA;AAeF;AAdE;EACE,kBAAA;EACA,WAAA;EACA,iBAAA;EACA,aAAA;EACA,yBAAA;EACA,yEAAA;EACA,kBAAA;EACA,gCAAA;EACA,SAAA;EACA,QAAA;AAgBJ;AAdE;EACE,eAAA;EACA,iBAAA;EACA,kBAAA;EACA,WDrBS;ECsBT,SAAA;EACA,kBAAA;EACA,oMAAA;AAgBJ;AAbE;EACE,kBAAA;EACA,WAAA;EACA,WAAA;EACA,WAAA;EACA,YAAA;EACA,YAAA;EACA,eAAA;EACA,uBAAA;AAeJ;AAdI;EACE,yBAAA;EACA,YAAA;AAgBN;AAbE;EACE,aAAA;EACA,uBAAA;EACA,gBAAA;EACA,qBAAA;AAeJ;AAbE;EAEE,iBAAA;EACA,mBAAA;EACA,yBAAA;EACA,cAAA;EACA,gBAAA;EACA,WAAA;EACA,uBAAA;EACA,4EAAA;AAcJ;AAbI;EACE,kBAAA;AAeN;;AAVA;EAEI;IACE,mBAAA;EAYJ;EAVE;IACE,eAAA;IACA,gBAAA;EAYJ;EAVE;IACE,iBAAA;IACA,iBAAA;EAYJ;EAXI;IACE,kBAAA;EAaN;EAVE;IACE,gBAAA;EAYJ;AACF","sourcesContent":["$font-family: 'Thasadith', sans-serif;\n\n$fwb: 700;\n$fwr: 400;\n\n$default-color: black;\n$color-text: #fff;\n$color-text-black: #0b0a0a;\n$color-btn: linear-gradient(180deg, rgba(148, 146, 141, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n$color-square: rgba(61, 61, 61, 0.8);\n\n%btn-light {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n}\n\n%popup-btn-light {\n  font-size: 3.5rem;\n  line-height: 140%;\n  border: none;\n  background: linear-gradient(180deg, #23221e 0%, rgba(255, 255, 249, 0) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n}\n","@import '../../../../../style/variables.scss';\n\n.warning {\n  position: absolute;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  top: 0;\n  background: rgba(0, 0, 0, 0.9);\n  user-select: none;\n  z-index: 1001;\n  &_inner {\n    max-width: 63.5rem;\n    width: 100%;\n    min-height: 30rem;\n    padding: 1rem;\n    border: 5px solid #7e7d7b;\n    background: linear-gradient(180deg, #1d1e1a 0%, rgba(55, 56, 52, 0) 100%);\n    position: absolute;\n    transform: translate(-50%, -50%);\n    left: 50%;\n    top: 50%;\n  }\n  &_text {\n    font-size: 5rem;\n    line-height: 140%;\n    text-align: center;\n    color: $color-text;\n    margin: 0;\n    margin-top: 5.7rem;\n    text-shadow: 0px 0px 30.959999084472656px #fff, 0px 0px 61.91999816894531px #fff, 0px 0px 216.72000122070312px #fff,\n      0px 0px 433.44000244140625px #fff, 0px 0px 743.0399780273438px #fff, 0px 0px 1300.3199462890625px #fff;\n  }\n  &_close {\n    position: absolute;\n    right: 2rem;\n    top: 1.5rem;\n    width: 4rem;\n    height: 4rem;\n    border: none;\n    cursor: pointer;\n    transition: 0.2s linear;\n    &:hover {\n      transform: translate(0.9);\n      opacity: 0.8;\n    }\n  }\n  &_btns {\n    display: flex;\n    justify-content: center;\n    margin-top: 5rem;\n    margin-bottom: 3.7rem;\n  }\n  &_btn {\n    @extend %popup-btn-light;\n    font-size: 3.5rem;\n    line-height: 5.5rem;\n    text-transform: uppercase;\n    height: 5.5rem;\n    max-width: 20rem;\n    width: 100%;\n    transition: 0.2s linear;\n    background: linear-gradient(180deg, #23221e 0%, rgba(255, 255, 249, 0) 100%);\n    &:nth-child(1) {\n      margin-right: 8rem;\n    }\n  }\n}\n\n@media (max-width: 400px) {\n  .warning {\n    &_inner {\n      min-height: inherit;\n    }\n    &_text {\n      font-size: 4rem;\n      margin-top: 3rem;\n    }\n    &_btn {\n      font-size: 2.5rem;\n      line-height: 140%;\n      &:nth-child(1) {\n        margin-right: 3rem;\n      }\n    }\n    &_btns {\n      margin-bottom: 0;\n    }\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/***/ "./src/assets/fonts/Ubuntu-Bold.eot":
/*!******************************************!*\
  !*** ./src/assets/fonts/Ubuntu-Bold.eot ***!
  \******************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "assets/Ubuntu-Bold.eot";
...
module.exports = __webpack_require__.p + "assets/Ubuntu-Bold.ttf";

/***/ }),

/***/ "./src/assets/fonts/Ubuntu-Bold.woff":
/*!*******************************************!*\
  !*** ./src/assets/fonts/Ubuntu-Bold.woff ***!
  \*******************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "assets/Ubuntu-Bold.woff";

/***/ }),

/***/ "./src/assets/fonts/Ubuntu-Regular.eot":
/*!*********************************************!*\
  !*** ./src/assets/fonts/Ubuntu-Regular.eot ***!
  \*********************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "assets/Ubuntu-Regular.eot";
...
module.exports = __webpack_require__.p + "assets/Ubuntu-Regular.ttf";

/***/ }),

/***/ "./src/assets/fonts/Ubuntu-Regular.woff":
/*!**********************************************!*\
  !*** ./src/assets/fonts/Ubuntu-Regular.woff ***!
  \**********************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "assets/Ubuntu-Regular.woff";
...
module.exports = __webpack_require__.p + "assets/Ubuntu-Regular.woff2";
...
/******/ })()
;
//# sourceMappingURL=bundle-75072ee7cd285c3a5411.js.map