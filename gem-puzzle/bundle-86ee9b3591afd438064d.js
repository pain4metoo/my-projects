    ...
    this.headerListener = type => {
      switch (type) {
        ...
        case _common_state_types__WEBPACK_IMPORTED_MODULE_2__.StateOptions.changeLanguage:
          ...
          mobileStopBtn.node.textContent = `${_common_state__WEBPACK_IMPORTED_MODULE_1__.state.getLanguage() ? 'stop' : 'стоп'}`;
          break;
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".main_counters {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin: 0 auto;\n  margin-top: 2rem;\n  width: 100%;\n}\n.main_counters_block_right {\n  max-width: 28rem;\n  width: 100%;\n}\n.main_counters_moves {\n  display: flex;\n  align-items: center;\n  user-select: none;\n  position: relative;\n  z-index: 1;\n}\n.main_counters_text {\n  margin-right: 0.5rem;\n}\n.main_counters_time {\n  display: flex;\n  align-items: center;\n  user-select: none;\n  position: relative;\n  z-index: 1;\n}\n.main_counters_time_text {\n  margin-right: 0.5rem;\n}\n.main_counters_txt {\n  font-size: 3.7rem;\n  line-height: 140%;\n  color: #0b0a0a;\n  margin: 0;\n}\n\n@media (max-width: 1920px) and (max-height: 1000px) {\n  .main_counters {\n    max-width: 57rem;\n  }\n}\n@media (max-width: 870px) {\n  .main_counters {\n    max-width: 55rem;\n  }\n  .main_counters_block_right {\n    max-width: 23rem;\n    width: 100%;\n  }\n  .main_counters_txt {\n    font-size: 2.9rem;\n  }\n}\n@media (max-width: 570px) {\n  .main_counters {\n    max-width: 50rem;\n  }\n}\n@media (max-width: 450px) {\n  .main_counters {\n    margin: 0;\n  }\n  .main_counters_block_right {\n    max-width: 16rem;\n    width: 100%;\n  }\n  .main_counters_moves {\n    width: 100%;\n  }\n  .main_counters_txt {\n    font-size: 2.1rem;\n  }\n}", "",{"version":3,"sources":["webpack://./src/ts/components/main/counters/counter.scss","webpack://./src/style/variables.scss"],"names":[],"mappings":"AAEA;EACE,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,cAAA;EACA,gBAAA;EACA,WAAA;AADF;AAEE;EACE,gBAAA;EACA,WAAA;AAAJ;AAEE;EACE,aAAA;EACA,mBAAA;EACA,iBAAA;EACA,kBAAA;EACA,UAAA;AAAJ;AAEE;EACE,oBAAA;AAAJ;AAEE;EACE,aAAA;EACA,mBAAA;EACA,iBAAA;EACA,kBAAA;EACA,UAAA;AAAJ;AAEE;EACE,oBAAA;AAAJ;AAEE;EACE,iBAAA;EACA,iBAAA;EACA,cC7Be;ED8Bf,SAAA;AAAJ;;AAIA;EACE;IACE,gBAAA;EADF;AACF;AAIA;EACE;IACE,gBAAA;EAFF;EAGE;IACE,gBAAA;IACA,WAAA;EADJ;EAGE;IACE,iBAAA;EADJ;AACF;AAKA;EACE;IACE,gBAAA;EAHF;AACF;AAMA;EACE;IACE,SAAA;EAJF;EAKE;IACE,gBAAA;IACA,WAAA;EAHJ;EAKE;IACE,WAAA;EAHJ;EAKE;IACE,iBAAA;EAHJ;AACF","sourcesContent":["@import '../../../../style/variables.scss';\n\n.main_counters {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin: 0 auto;\n  margin-top: 2rem;\n  width: 100%;\n  &_block_right {\n    max-width: 28rem;\n    width: 100%;\n  }\n  &_moves {\n    display: flex;\n    align-items: center;\n    user-select: none;\n    position: relative;\n    z-index: 1;\n  }\n  &_text {\n    margin-right: 0.5rem;\n  }\n  &_time {\n    display: flex;\n    align-items: center;\n    user-select: none;\n    position: relative;\n    z-index: 1;\n  }\n  &_time_text {\n    margin-right: 0.5rem;\n  }\n  &_txt {\n    font-size: 3.7rem;\n    line-height: 140%;\n    color: $color-text-black;\n    margin: 0;\n  }\n}\n\n@media (max-width: 1920px) and (max-height: 1000px) {\n  .main_counters {\n    max-width: 57rem;\n  }\n}\n\n@media (max-width: 870px) {\n  .main_counters {\n    max-width: 55rem;\n    &_block_right {\n      max-width: 23rem;\n      width: 100%;\n    }\n    &_txt {\n      font-size: 2.9rem;\n    }\n  }\n}\n\n@media (max-width: 570px) {\n  .main_counters {\n    max-width: 50rem;\n  }\n}\n\n@media (max-width: 450px) {\n  .main_counters {\n    margin: 0;\n    &_block_right {\n      max-width: 16rem;\n      width: 100%;\n    }\n    &_moves {\n      width: 100%;\n    }\n    &_txt {\n      font-size: 2.1rem;\n    }\n  }\n}\n","$font-family: 'Thasadith', sans-serif;\n\n$fwb: 700;\n$fwr: 400;\n\n$default-color: black;\n$color-text: #fff;\n$color-text-black: #0b0a0a;\n$color-btn: linear-gradient(180deg, rgba(148, 146, 141, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n$color-square: rgba(61, 61, 61, 0.8);\n\n%header-btns {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  border: none;\n  background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n\n  backdrop-filter: blur(10px);\n  width: 100%;\n  height: 100%;\n  transition: 0.2s linear;\n  &:hover {\n    opacity: 0.8;\n  }\n  &:active {\n    opacity: 0.8;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n\n%header-mobile-btn {\n  font-size: 2.5rem;\n  line-height: 140%;\n  display: none;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  background: $color-btn;\n  width: 10rem;\n\n  transition: 0.2s linear;\n  margin-top: 1.5rem;\n  margin-left: 1.5rem;\n  &:hover {\n    opacity: 0.8;\n  }\n  &:active {\n    opacity: 0.8;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n\n%frame-btns {\n  font-size: 2.5rem;\n  line-height: 140%;\n  width: 10.5rem;\n  background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n  backdrop-filter: blur(10px);\n  transition: 0.2s linear;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    opacity: 0.8;\n  }\n  &:active {\n    opacity: 0.8;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n%collect-btn {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  padding: 0.5rem 0rem;\n  max-width: 25.5rem;\n  width: 100%;\n  background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n\n  backdrop-filter: blur(10px);\n  transition: 0.2s linear;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    opacity: 0.8;\n  }\n  &:active {\n    opacity: 0.8;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n%popup-btn {\n  font-size: 3rem;\n  line-height: 140%;\n  position: absolute;\n  bottom: 0rem;\n  width: 100%;\n  border: none;\n  background: linear-gradient(180deg, #23221e 0%, rgba(255, 255, 249, 0) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  transition: 0.2s linear;\n  &:hover {\n    opacity: 0.8;\n  }\n  &:active {\n    opacity: 0.8;\n  }\n  &:disabled {\n    background: #3d3d3d;\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n%warning-btns {\n  font-size: 3.5rem;\n  line-height: 140%;\n  border: none;\n  background: linear-gradient(180deg, #23221e 0%, rgba(255, 255, 249, 0) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  text-transform: uppercase;\n  height: 5.5rem;\n  max-width: 20rem;\n  width: 100%;\n  transition: 0.2s linear;\n  &:hover {\n    opacity: 0.8;\n  }\n  &:active {\n    opacity: 0.8;\n  }\n}\n%close-btn {\n  width: 2.5rem;\n  height: 2.5rem;\n  cursor: pointer;\n  transition: 0.2s linear;\n  &:hover {\n    opacity: 0.5;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/******/ })()
;
//# sourceMappingURL=bundle-86ee9b3591afd438064d.js.map