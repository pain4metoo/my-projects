...
(function (StateOptions) {
  ...
  StateOptions["setGameAnimation"] = "set-game-animation";
  StateOptions["removeGameAnimation"] = "remove-game-animation";
  StateOptions["changeGameMode"] = "change-game-mode";
...
class State {
  ...
  setGameMode(flag) {
    ...
    state.onUpdate.emit(_state_types__WEBPACK_IMPORTED_MODULE_2__.StateOptions.changeGameMode);
  }
  getGameMode() {
    return this._data.appSettings.hardMode;
  }
  setStartGameMode(flag) {
  ...
  setGameAnimation() {
    state.onUpdate.emit(_state_types__WEBPACK_IMPORTED_MODULE_2__.StateOptions.setGameAnimation);
  }
  removGametAnimation() {
    state.onUpdate.emit(_state_types__WEBPACK_IMPORTED_MODULE_2__.StateOptions.removeGameAnimation);
  }
}
const initialState = {
  gameSettings: {
...
/* harmony import */ var _assets_image_firework_gif__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../assets/image/firework.gif */ "./src/assets/image/firework.gif");
    ...
    this.appListener = type => {
      switch (type) {
        ...
        case _common_state_types__WEBPACK_IMPORTED_MODULE_2__.StateOptions.winGame:
          if (_common_state__WEBPACK_IMPORTED_MODULE_1__.state.getAnimation()) {
            this.fireWork = new _common_control__WEBPACK_IMPORTED_MODULE_0__["default"](main.node, 'img', 'firework');
            this.fireWork.node.src = _assets_image_firework_gif__WEBPACK_IMPORTED_MODULE_7__;
          }
          break;
...
class Game extends _common_control__WEBPACK_IMPORTED_MODULE_0__["default"] {
    ...
    this.gameListener = type => {
      switch (type) {
        ...
        case _common_state_types__WEBPACK_IMPORTED_MODULE_3__.StateOptions.deleteTargetFromStorage:
          ...
          break;
        case _common_state_types__WEBPACK_IMPORTED_MODULE_3__.StateOptions.setMove:
          this.isExtremeMode();
          break;
        case _common_state_types__WEBPACK_IMPORTED_MODULE_3__.StateOptions.changeGameMode:
          if (!_common_state__WEBPACK_IMPORTED_MODULE_1__.state.getGameMode()) {
            this.removeExtremeMode();
          }
          break;
        case _common_state_types__WEBPACK_IMPORTED_MODULE_3__.StateOptions.stopGame:
  ...
  shuffleCycle() {
    ...
    _common_state__WEBPACK_IMPORTED_MODULE_1__.state.setGameAnimation();
    const handle = setInterval(() => {
      ...
      if (counter === maxShuffle) {
        ...
        _common_state__WEBPACK_IMPORTED_MODULE_1__.state.removGametAnimation();
  ...
  isExtremeMode() {
    if (_common_state__WEBPACK_IMPORTED_MODULE_1__.state.getGameMode() && !_common_state__WEBPACK_IMPORTED_MODULE_1__.state.getStartGameMode()) {
      _common_state__WEBPACK_IMPORTED_MODULE_1__.state.setStartGameMode(true);
      this.onExtremeMode();
    } else {
      if (!_common_state__WEBPACK_IMPORTED_MODULE_1__.state.getGameMode()) {
        _common_state__WEBPACK_IMPORTED_MODULE_1__.state.setStartGameMode(false);
        this.removeExtremeMode();
      }
    }
  }
  removeExtremeMode(isStopGame) {
  ...
  extremeMode() {
    ...
    const sizeField = _common_state__WEBPACK_IMPORTED_MODULE_1__.state.getFrameSize();
...
class Main extends _common_control__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(parentNode) {
    ...
    this.mainListener = type => {
      switch (type) {
        case _common_state_types__WEBPACK_IMPORTED_MODULE_2__.StateOptions.setGameAnimation:
          if (_common_state__WEBPACK_IMPORTED_MODULE_1__.state.getAnimation()) {
          ...
          break;
        case _common_state_types__WEBPACK_IMPORTED_MODULE_2__.StateOptions.removeGameAnimation:
          sectionGameContainer.node.classList.remove('main_game_animation');
          break;
...
class ResultPopup extends _common_control__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  createTable(localStorage) {
    ...
    const tBody = new _common_control__WEBPACK_IMPORTED_MODULE_0__["default"](table.node, 'tbody', 'popups_result_tbody');
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".footer {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  flex-shrink: 0;\n  background: rgba(20, 19, 17, 0.5);\n  backdrop-filter: blur(0.6rem);\n  position: relative;\n  z-index: 1;\n}\n.footer_year {\n  font-size: 1.5rem;\n  line-height: 1.2rem;\n  color: #fff;\n  margin-left: 4rem;\n}\n.footer_link {\n  font-size: 1.5rem;\n  line-height: 1.2rem;\n  color: #fff;\n  text-decoration: none;\n  margin-right: 4rem;\n  transition: 0.2s linear;\n}\n.footer_link:hover {\n  color: orange;\n  opacity: 0.5;\n}", "",{"version":3,"sources":["webpack://./src/ts/components/footer/footer.scss","webpack://./src/style/variables.scss"],"names":[],"mappings":"AAEA;EACE,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,cAAA;EACA,iCAAA;EACA,6BAAA;EACA,kBAAA;EACA,UAAA;AADF;AAEE;EACE,iBAAA;EACA,mBAAA;EACA,WCHS;EDIT,iBAAA;AAAJ;AAEE;EACE,iBAAA;EACA,mBAAA;EACA,WCTS;EDUT,qBAAA;EACA,kBAAA;EACA,uBAAA;AAAJ;AACI;EACE,aAAA;EACA,YAAA;AACN","sourcesContent":["@import '../../../assets/../style/variables.scss';\n\n.footer {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  flex-shrink: 0;\n  background: rgba(20, 19, 17, 0.5);\n  backdrop-filter: blur(0.6rem);\n  position: relative;\n  z-index: 1;\n  &_year {\n    font-size: 1.5rem;\n    line-height: 1.2rem;\n    color: $color-text;\n    margin-left: 4rem;\n  }\n  &_link {\n    font-size: 1.5rem;\n    line-height: 1.2rem;\n    color: $color-text;\n    text-decoration: none;\n    margin-right: 4rem;\n    transition: 0.2s linear;\n    &:hover {\n      color: orange;\n      opacity: 0.5;\n    }\n  }\n}\n","$font-family: 'Thasadith', sans-serif;\n\n$fwb: 700;\n$fwr: 400;\n\n// animation\n$count: 15;\n$size: 50px;\n$margin: $size * -0.5;\n\n$default-color: black;\n$color-text: #fff;\n$color-text-black: #0b0a0a;\n$color-btn: linear-gradient(180deg, rgba(148, 146, 141, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n$color-square: rgba(61, 61, 61, 0.8);\n\n%header-btns {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  border: none;\n  background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n\n  backdrop-filter: blur(10px);\n  width: 100%;\n  height: 100%;\n  transition: 0.2s linear;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n\n%header-mobile-btn {\n  font-size: 2.5rem;\n  line-height: 140%;\n  display: none;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  background: $color-btn;\n  width: 10rem;\n\n  transition: 0.2s linear;\n  margin-top: 1.5rem;\n  margin-left: 1.5rem;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n\n%frame-btns {\n  font-size: 2.5rem;\n  line-height: 140%;\n  width: 10.5rem;\n  background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n  backdrop-filter: blur(10px);\n  transition: 0.2s linear;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n%collect-btn {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  padding: 0.5rem 0rem;\n  max-width: 25.5rem;\n  width: 100%;\n  background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n\n  backdrop-filter: blur(10px);\n  transition: 0.2s linear;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n%popup-btn {\n  font-size: 3rem;\n  line-height: 140%;\n  position: absolute;\n  bottom: 0rem;\n  width: 100%;\n  border: none;\n  background: linear-gradient(180deg, #23221e 0%, rgba(255, 255, 249, 0) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  transition: 0.2s linear;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    background: #3d3d3d;\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n%warning-btns {\n  font-size: 3.5rem;\n  line-height: 140%;\n  border: none;\n  background: linear-gradient(180deg, #23221e 0%, rgba(255, 255, 249, 0) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  text-transform: uppercase;\n  height: 5.5rem;\n  max-width: 20rem;\n  width: 100%;\n  transition: 0.2s linear;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n}\n%close-btn {\n  width: 2.5rem;\n  height: 2.5rem;\n  cursor: pointer;\n  transition: 0.2s linear;\n  &:hover {\n    opacity: 0.5;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".main_frame_other_size {\n  font-size: 2.5rem;\n  line-height: 140%;\n  width: 10.5rem;\n  background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n  backdrop-filter: blur(10px);\n  transition: 0.2s linear;\n  border: none;\n  color: #fff;\n  cursor: pointer;\n  user-select: none;\n}\n.main_frame_other_size:hover {\n  box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff, 0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  opacity: 0.8;\n}\n.main_frame_other_size:active {\n  box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff, 0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  opacity: 0.8;\n}\n.main_frame_other_size:disabled {\n  opacity: 0.3;\n  cursor: not-allowed;\n}\n\n.main_frame_btn {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: #fff;\n  padding: 0.5rem 0rem;\n  max-width: 25.5rem;\n  width: 100%;\n  background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n  backdrop-filter: blur(10px);\n  transition: 0.2s linear;\n  cursor: pointer;\n  user-select: none;\n}\n.main_frame_btn:hover {\n  box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff, 0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  opacity: 0.8;\n}\n.main_frame_btn:active {\n  box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff, 0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  opacity: 0.8;\n}\n.main_frame_btn:disabled {\n  opacity: 0.3;\n  cursor: not-allowed;\n}\n\n.main_frame {\n  display: flex;\n  flex-direction: column;\n  text-align: center;\n  align-items: center;\n  margin-top: 3.8rem;\n}\n.main_frame_block {\n  display: flex;\n  align-items: center;\n  user-select: none;\n}\n.main_frame_text {\n  margin: 0;\n}\n.main_frame_size {\n  margin: 0;\n  margin-left: 1rem;\n}\n.main_frame_other {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  margin-top: 3rem;\n  user-select: none;\n  width: 100%;\n}\n.main_frame_other_text {\n  margin: 0;\n}\n.main_frame_other_size:not(:last-child) {\n  margin-right: 0.4rem;\n}\n.main_frame_other_size_active {\n  background: rgb(142, 122, 61);\n}\n.main_frame_btn_active {\n  background: rgb(142, 122, 61);\n}\n\n@media (max-width: 870px) {\n  .main_frame {\n    max-width: 55rem;\n    margin-top: 2rem;\n  }\n}\n@media (max-width: 670px) {\n  .main_frame {\n    max-width: 50rem;\n    margin-top: 4rem;\n  }\n  .main_frame_other_size {\n    font-size: 2.1rem;\n  }\n}\n@media (max-width: 570px) {\n  .main_frame {\n    max-width: inherit;\n    margin-top: 4rem;\n  }\n  .main_frame_other_size {\n    font-size: 2.1rem;\n  }\n}\n@media (max-width: 450px) {\n  .main_frame {\n    max-width: inherit;\n    margin-top: 4rem;\n  }\n  .main_frame_other_size {\n    font-size: 1.7rem;\n  }\n  .main_frame_btn {\n    font-size: 2.1rem;\n  }\n}", "",{"version":3,"sources":["webpack://./src/style/variables.scss","webpack://./src/ts/components/main/frame-size/frame-size.scss"],"names":[],"mappings":"AA4EA;EACE,iBAAA;EACA,iBAAA;EACA,cAAA;EACA,+EAAA;EACA,2BAAA;EACA,uBAAA;EACA,YAAA;EACA,WAzEW;EA0EX,eAAA;EACA,iBAAA;AC3EF;AD4EE;EACE,mKAAA;EAEA,YAAA;AC3EJ;AD6EE;EACE,mKAAA;EAEA,YAAA;AC5EJ;AD8EE;EACE,YAAA;EACA,mBAAA;AC5EJ;;AD+EA;EACE,iBAAA;EACA,iBAAA;EACA,YAAA;EACA,WA/FW;EAgGX,oBAAA;EACA,kBAAA;EACA,WAAA;EACA,+EAAA;EAEA,2BAAA;EACA,uBAAA;EACA,eAAA;EACA,iBAAA;AC7EF;AD8EE;EACE,mKAAA;EAEA,YAAA;AC7EJ;AD+EE;EACE,mKAAA;EAEA,YAAA;AC9EJ;ADgFE;EACE,YAAA;EACA,mBAAA;AC9EJ;;AAhDA;EACE,aAAA;EACA,sBAAA;EACA,kBAAA;EACA,mBAAA;EACA,kBAAA;AAmDF;AAlDE;EACE,aAAA;EACA,mBAAA;EACA,iBAAA;AAoDJ;AAlDE;EACE,SAAA;AAoDJ;AAlDE;EACE,SAAA;EACA,iBAAA;AAoDJ;AAlDE;EACE,aAAA;EACA,mBAAA;EACA,uBAAA;EACA,gBAAA;EACA,iBAAA;EACA,WAAA;AAoDJ;AAlDE;EACE,SAAA;AAoDJ;AAhDI;EACE,oBAAA;AAkDN;AA/CE;EACE,6BAAA;AAiDJ;AA5CE;EACE,6BAAA;AA8CJ;;AA1CA;EACE;IACE,gBAAA;IACA,gBAAA;EA6CF;AACF;AA1CA;EACE;IACE,gBAAA;IACA,gBAAA;EA4CF;EA3CE;IACE,iBAAA;EA6CJ;AACF;AAzCA;EACE;IACE,kBAAA;IACA,gBAAA;EA2CF;EA1CE;IACE,iBAAA;EA4CJ;AACF;AAxCA;EACE;IACE,kBAAA;IACA,gBAAA;EA0CF;EAzCE;IACE,iBAAA;EA2CJ;EAzCE;IACE,iBAAA;EA2CJ;AACF","sourcesContent":["$font-family: 'Thasadith', sans-serif;\n\n$fwb: 700;\n$fwr: 400;\n\n// animation\n$count: 15;\n$size: 50px;\n$margin: $size * -0.5;\n\n$default-color: black;\n$color-text: #fff;\n$color-text-black: #0b0a0a;\n$color-btn: linear-gradient(180deg, rgba(148, 146, 141, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n$color-square: rgba(61, 61, 61, 0.8);\n\n%header-btns {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  border: none;\n  background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n\n  backdrop-filter: blur(10px);\n  width: 100%;\n  height: 100%;\n  transition: 0.2s linear;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n\n%header-mobile-btn {\n  font-size: 2.5rem;\n  line-height: 140%;\n  display: none;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  background: $color-btn;\n  width: 10rem;\n\n  transition: 0.2s linear;\n  margin-top: 1.5rem;\n  margin-left: 1.5rem;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n\n%frame-btns {\n  font-size: 2.5rem;\n  line-height: 140%;\n  width: 10.5rem;\n  background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n  backdrop-filter: blur(10px);\n  transition: 0.2s linear;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n%collect-btn {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  padding: 0.5rem 0rem;\n  max-width: 25.5rem;\n  width: 100%;\n  background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n\n  backdrop-filter: blur(10px);\n  transition: 0.2s linear;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n%popup-btn {\n  font-size: 3rem;\n  line-height: 140%;\n  position: absolute;\n  bottom: 0rem;\n  width: 100%;\n  border: none;\n  background: linear-gradient(180deg, #23221e 0%, rgba(255, 255, 249, 0) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  transition: 0.2s linear;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    background: #3d3d3d;\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n%warning-btns {\n  font-size: 3.5rem;\n  line-height: 140%;\n  border: none;\n  background: linear-gradient(180deg, #23221e 0%, rgba(255, 255, 249, 0) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  text-transform: uppercase;\n  height: 5.5rem;\n  max-width: 20rem;\n  width: 100%;\n  transition: 0.2s linear;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n}\n%close-btn {\n  width: 2.5rem;\n  height: 2.5rem;\n  cursor: pointer;\n  transition: 0.2s linear;\n  &:hover {\n    opacity: 0.5;\n  }\n}\n","@import '../../../../style/variables.scss';\n\n.main_frame {\n  display: flex;\n  flex-direction: column;\n  text-align: center;\n  align-items: center;\n  margin-top: 3.8rem;\n  &_block {\n    display: flex;\n    align-items: center;\n    user-select: none;\n  }\n  &_text {\n    margin: 0;\n  }\n  &_size {\n    margin: 0;\n    margin-left: 1rem;\n  }\n  &_other {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    margin-top: 3rem;\n    user-select: none;\n    width: 100%;\n  }\n  &_other_text {\n    margin: 0;\n  }\n  &_other_size {\n    @extend %frame-btns;\n    &:not(:last-child) {\n      margin-right: 0.4rem;\n    }\n  }\n  &_other_size_active {\n    background: rgb(142, 122, 61);\n  }\n  &_btn {\n    @extend %collect-btn;\n  }\n  &_btn_active {\n    background: rgb(142, 122, 61);\n  }\n}\n\n@media (max-width: 870px) {\n  .main_frame {\n    max-width: 55rem;\n    margin-top: 2rem;\n  }\n}\n\n@media (max-width: 670px) {\n  .main_frame {\n    max-width: 50rem;\n    margin-top: 4rem;\n    &_other_size {\n      font-size: 2.1rem;\n    }\n  }\n}\n\n@media (max-width: 570px) {\n  .main_frame {\n    max-width: inherit;\n    margin-top: 4rem;\n    &_other_size {\n      font-size: 2.1rem;\n    }\n  }\n}\n\n@media (max-width: 450px) {\n  .main_frame {\n    max-width: inherit;\n    margin-top: 4rem;\n    &_other_size {\n      font-size: 1.7rem;\n    }\n    &_btn {\n      font-size: 2.1rem;\n    }\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".main {\n  max-width: 120rem;\n  padding: 0 1.5rem;\n  margin: 0 auto;\n  flex-grow: 1;\n}\n\n@media (max-width: 870px) {\n  .main {\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n  }\n}\n@media (max-width: 570px) {\n  .main {\n    margin: 0;\n  }\n}", "",{"version":3,"sources":["webpack://./src/ts/components/main/main.scss"],"names":[],"mappings":"AAAA;EACE,iBAAA;EACA,iBAAA;EACA,cAAA;EACA,YAAA;AACF;;AAEA;EACE;IACE,aAAA;IACA,sBAAA;IACA,uBAAA;EACF;AACF;AAEA;EACE;IACE,SAAA;EAAF;AACF","sourcesContent":[".main {\n  max-width: 120rem;\n  padding: 0 1.5rem;\n  margin: 0 auto;\n  flex-grow: 1;\n}\n\n@media (max-width: 870px) {\n  .main {\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n  }\n}\n\n@media (max-width: 570px) {\n  .main {\n    margin: 0;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".popups_collect {\n  width: 100%;\n  height: 100%;\n  margin-top: 4.5rem;\n}\n.popups_collect_info {\n  margin-top: 4rem;\n}\n.popups_collect_title {\n  font-size: 3.5rem;\n  line-height: 140%;\n  text-align: center;\n  color: #fff;\n  margin: 0;\n}\n.popups_collect_time {\n  font-size: 2.4rem;\n  line-height: 140%;\n  text-align: center;\n  color: #fff;\n  margin: 0;\n  margin-bottom: 1rem;\n}\n.popups_collect_total_time {\n  font-size: 2.4rem;\n  line-height: 140%;\n  text-align: center;\n  color: #fff;\n  margin: 0;\n  margin-bottom: 1rem;\n}\n.popups_collect_moves {\n  font-size: 2.4rem;\n  line-height: 140%;\n  text-align: center;\n  color: gainsboro;\n  margin: 0;\n  margin-bottom: 1rem;\n}\n\n@media (max-width: 580px) {\n  .popups_collect_title {\n    font-size: 2.5rem;\n  }\n}", "",{"version":3,"sources":["webpack://./src/ts/components/main/popups/collect-popup/collect-popup.scss","webpack://./src/style/variables.scss"],"names":[],"mappings":"AAEA;EACE,WAAA;EACA,YAAA;EACA,kBAAA;AADF;AAEE;EACE,gBAAA;AAAJ;AAEE;EACE,iBAAA;EACA,iBAAA;EACA,kBAAA;EACA,WCFS;EDGT,SAAA;AAAJ;AAEE;EACE,iBAAA;EACA,iBAAA;EACA,kBAAA;EACA,WCTS;EDUT,SAAA;EACA,mBAAA;AAAJ;AAEE;EACE,iBAAA;EACA,iBAAA;EACA,kBAAA;EACA,WCjBS;EDkBT,SAAA;EACA,mBAAA;AAAJ;AAEE;EACE,iBAAA;EACA,iBAAA;EACA,kBAAA;EACA,gBAAA;EACA,SAAA;EACA,mBAAA;AAAJ;;AAIA;EAEI;IACE,iBAAA;EAFJ;AACF","sourcesContent":["@import '../../../../../style/variables.scss';\n\n.popups_collect {\n  width: 100%;\n  height: 100%;\n  margin-top: 4.5rem;\n  &_info {\n    margin-top: 4rem;\n  }\n  &_title {\n    font-size: 3.5rem;\n    line-height: 140%;\n    text-align: center;\n    color: $color-text;\n    margin: 0;\n  }\n  &_time {\n    font-size: 2.4rem;\n    line-height: 140%;\n    text-align: center;\n    color: $color-text;\n    margin: 0;\n    margin-bottom: 1rem;\n  }\n  &_total_time {\n    font-size: 2.4rem;\n    line-height: 140%;\n    text-align: center;\n    color: $color-text;\n    margin: 0;\n    margin-bottom: 1rem;\n  }\n  &_moves {\n    font-size: 2.4rem;\n    line-height: 140%;\n    text-align: center;\n    color: gainsboro;\n    margin: 0;\n    margin-bottom: 1rem;\n  }\n}\n\n@media (max-width: 580px) {\n  .popups_collect {\n    &_title {\n      font-size: 2.5rem;\n    }\n  }\n}\n","$font-family: 'Thasadith', sans-serif;\n\n$fwb: 700;\n$fwr: 400;\n\n// animation\n$count: 15;\n$size: 50px;\n$margin: $size * -0.5;\n\n$default-color: black;\n$color-text: #fff;\n$color-text-black: #0b0a0a;\n$color-btn: linear-gradient(180deg, rgba(148, 146, 141, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n$color-square: rgba(61, 61, 61, 0.8);\n\n%header-btns {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  border: none;\n  background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n\n  backdrop-filter: blur(10px);\n  width: 100%;\n  height: 100%;\n  transition: 0.2s linear;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n\n%header-mobile-btn {\n  font-size: 2.5rem;\n  line-height: 140%;\n  display: none;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  background: $color-btn;\n  width: 10rem;\n\n  transition: 0.2s linear;\n  margin-top: 1.5rem;\n  margin-left: 1.5rem;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n\n%frame-btns {\n  font-size: 2.5rem;\n  line-height: 140%;\n  width: 10.5rem;\n  background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n  backdrop-filter: blur(10px);\n  transition: 0.2s linear;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n%collect-btn {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  padding: 0.5rem 0rem;\n  max-width: 25.5rem;\n  width: 100%;\n  background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n\n  backdrop-filter: blur(10px);\n  transition: 0.2s linear;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n%popup-btn {\n  font-size: 3rem;\n  line-height: 140%;\n  position: absolute;\n  bottom: 0rem;\n  width: 100%;\n  border: none;\n  background: linear-gradient(180deg, #23221e 0%, rgba(255, 255, 249, 0) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  transition: 0.2s linear;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    background: #3d3d3d;\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n%warning-btns {\n  font-size: 3.5rem;\n  line-height: 140%;\n  border: none;\n  background: linear-gradient(180deg, #23221e 0%, rgba(255, 255, 249, 0) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  text-transform: uppercase;\n  height: 5.5rem;\n  max-width: 20rem;\n  width: 100%;\n  transition: 0.2s linear;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n}\n%close-btn {\n  width: 2.5rem;\n  height: 2.5rem;\n  cursor: pointer;\n  transition: 0.2s linear;\n  &:hover {\n    opacity: 0.5;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".popups_finish {\n  margin-top: 4.5rem;\n}\n.popups_finish_info {\n  margin-top: 4rem;\n}\n.popups_finish_title {\n  font-size: 3.5rem;\n  line-height: 140%;\n  text-align: center;\n  color: #fff;\n  margin: 0;\n}\n.popups_finish_time {\n  font-size: 2.4rem;\n  line-height: 140%;\n  text-align: center;\n  color: #fff;\n  margin: 0;\n  margin-bottom: 1rem;\n}\n.popups_finish_moves {\n  font-size: 2.4rem;\n  line-height: 140%;\n  text-align: center;\n  color: #fff;\n  margin: 0;\n  margin-bottom: 1rem;\n}\n\n@media (max-width: 580px) {\n  .popups_finish_title {\n    font-size: 2.5rem;\n  }\n}", "",{"version":3,"sources":["webpack://./src/ts/components/main/popups/finish-popup/finish-popup.scss","webpack://./src/style/variables.scss"],"names":[],"mappings":"AAEA;EACE,kBAAA;AADF;AAEE;EACE,gBAAA;AAAJ;AAEE;EACE,iBAAA;EACA,iBAAA;EACA,kBAAA;EACA,WAAA;EACA,SAAA;AAAJ;AAEE;EACE,iBAAA;EACA,iBAAA;EACA,kBAAA;EACA,WCPS;EDQT,SAAA;EACA,mBAAA;AAAJ;AAEE;EACE,iBAAA;EACA,iBAAA;EACA,kBAAA;EACA,WCfS;EDgBT,SAAA;EACA,mBAAA;AAAJ;;AAIA;EAEI;IACE,iBAAA;EAFJ;AACF","sourcesContent":["@import '../../../../../style/variables.scss';\n\n.popups_finish {\n  margin-top: 4.5rem;\n  &_info {\n    margin-top: 4rem;\n  }\n  &_title {\n    font-size: 3.5rem;\n    line-height: 140%;\n    text-align: center;\n    color: $color-text;\n    margin: 0;\n  }\n  &_time {\n    font-size: 2.4rem;\n    line-height: 140%;\n    text-align: center;\n    color: $color-text;\n    margin: 0;\n    margin-bottom: 1rem;\n  }\n  &_moves {\n    font-size: 2.4rem;\n    line-height: 140%;\n    text-align: center;\n    color: $color-text;\n    margin: 0;\n    margin-bottom: 1rem;\n  }\n}\n\n@media (max-width: 580px) {\n  .popups_finish {\n    &_title {\n      font-size: 2.5rem;\n    }\n  }\n}\n","$font-family: 'Thasadith', sans-serif;\n\n$fwb: 700;\n$fwr: 400;\n\n// animation\n$count: 15;\n$size: 50px;\n$margin: $size * -0.5;\n\n$default-color: black;\n$color-text: #fff;\n$color-text-black: #0b0a0a;\n$color-btn: linear-gradient(180deg, rgba(148, 146, 141, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n$color-square: rgba(61, 61, 61, 0.8);\n\n%header-btns {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  border: none;\n  background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n\n  backdrop-filter: blur(10px);\n  width: 100%;\n  height: 100%;\n  transition: 0.2s linear;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n\n%header-mobile-btn {\n  font-size: 2.5rem;\n  line-height: 140%;\n  display: none;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  background: $color-btn;\n  width: 10rem;\n\n  transition: 0.2s linear;\n  margin-top: 1.5rem;\n  margin-left: 1.5rem;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n\n%frame-btns {\n  font-size: 2.5rem;\n  line-height: 140%;\n  width: 10.5rem;\n  background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n  backdrop-filter: blur(10px);\n  transition: 0.2s linear;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n%collect-btn {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  padding: 0.5rem 0rem;\n  max-width: 25.5rem;\n  width: 100%;\n  background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n\n  backdrop-filter: blur(10px);\n  transition: 0.2s linear;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n%popup-btn {\n  font-size: 3rem;\n  line-height: 140%;\n  position: absolute;\n  bottom: 0rem;\n  width: 100%;\n  border: none;\n  background: linear-gradient(180deg, #23221e 0%, rgba(255, 255, 249, 0) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  transition: 0.2s linear;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    background: #3d3d3d;\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n%warning-btns {\n  font-size: 3.5rem;\n  line-height: 140%;\n  border: none;\n  background: linear-gradient(180deg, #23221e 0%, rgba(255, 255, 249, 0) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  text-transform: uppercase;\n  height: 5.5rem;\n  max-width: 20rem;\n  width: 100%;\n  transition: 0.2s linear;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n}\n%close-btn {\n  width: 2.5rem;\n  height: 2.5rem;\n  cursor: pointer;\n  transition: 0.2s linear;\n  &:hover {\n    opacity: 0.5;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_URL_REPLACEMENT_0___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_0___);
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".popups_result_delete {\n  width: 2.5rem;\n  height: 2.5rem;\n  cursor: pointer;\n  transition: 0.2s linear;\n}\n.popups_result_delete:hover {\n  opacity: 0.5;\n}\n\n.popups_result {\n  width: 100%;\n  height: 100%;\n}\n.popups_result_title {\n  font-size: 4rem;\n  line-height: 140%;\n  text-align: center;\n  color: #fff;\n}\n.popups_result_table {\n  width: 100%;\n  height: 100%;\n  border-collapse: collapse;\n}\n.popups_result_thead {\n  height: 10rem;\n  border-bottom: 0.5rem solid #7f7e7c;\n}\n.popups_result_empty {\n  font-size: 5rem;\n  line-height: 140%;\n  color: #fff;\n  opacity: 0.3;\n  display: flex;\n  justify-content: center;\n}\n.popups_result_th {\n  font-size: 4rem;\n  line-height: 140%;\n}\n.popups_result_tr {\n  position: relative;\n  text-align: center;\n  color: #fff;\n  transition: linear 0.3s;\n}\n.popups_result_tr:hover:not(:first-child) {\n  background: #7f7e7c;\n  opacity: 0.5;\n}\n.popups_result_td {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: 0.2rem solid #7f7e7c;\n  z-index: 2;\n  padding-top: 0.7rem;\n  padding-bottom: 0.7rem;\n}\n.popups_result_td:nth-child(1) {\n  width: 7rem;\n  border-left: none;\n}\n.popups_result_td:nth-child(4) {\n  border-right: none;\n}\n.popups_result_list {\n  font-size: 2.4rem;\n  line-height: 140%;\n  padding: 0;\n  list-style: none;\n  color: #fff;\n  width: 100%;\n  margin: 0rem 0rem 4rem;\n}\n.popups_result_wrapper {\n  display: flex;\n  align-items: center;\n  list-style: none;\n  padding: 0;\n  background: linear-gradient(180deg, rgba(148, 146, 141, 0.11) 0%, rgba(255, 255, 255, 0.12) 100%);\n  margin-bottom: 1rem;\n  padding: 0.5rem;\n}\n.popups_result_item {\n  font-size: 3.5rem;\n  line-height: 140%;\n  color: white;\n}\n.popups_result_item:nth-child(2) {\n  max-width: 30rem;\n  width: 100%;\n}\n.popups_result_item:nth-child(3) {\n  max-width: 18.5rem;\n  width: 100%;\n}\n.popups_result_item:nth-child(4) {\n  max-width: 28rem;\n  width: 100%;\n}\n.popups_result_count {\n  max-width: 3rem;\n  width: 100%;\n}\n.popups_result_delete {\n  position: absolute;\n  background: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ") no-repeat center/contain;\n  right: 1rem;\n  top: 1.3rem;\n}\n\n@media (max-width: 638px) {\n  .popups_result_delete {\n    position: static;\n    background: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ") no-repeat center/contain;\n    border-top: 0.2rem solid #7f7e7c;\n    border-bottom: 0.2rem solid #7f7e7c;\n  }\n}\n@media (max-width: 470px) {\n  .popups_result_title {\n    font-size: 3rem;\n  }\n  .popups_result_td {\n    font-size: 1.6rem;\n  }\n  .popups_result_empty {\n    font-size: 3rem;\n  }\n}", "",{"version":3,"sources":["webpack://./src/style/variables.scss","webpack://./src/ts/components/main/popups/result-popup/result-popup.scss"],"names":[],"mappings":"AAuLA;EACE,aAAA;EACA,cAAA;EACA,eAAA;EACA,uBAAA;ACtLF;ADuLE;EACE,YAAA;ACrLJ;;AANA;EACE,WAAA;EACA,YAAA;AASF;AARE;EACE,eAAA;EACA,iBAAA;EACA,kBAAA;EACA,WDES;ACQb;AARE;EACE,WAAA;EACA,YAAA;EACA,yBAAA;AAUJ;AARE;EACE,aAAA;EACA,mCAAA;AAUJ;AARE;EACE,eAAA;EACA,iBAAA;EACA,WDZS;ECaT,YAAA;EACA,aAAA;EACA,uBAAA;AAUJ;AARE;EACE,eAAA;EACA,iBAAA;AAUJ;AARE;EACE,kBAAA;EACA,kBAAA;EACA,WDxBS;ECyBT,uBAAA;AAUJ;AATI;EACE,mBAAA;EACA,YAAA;AAWN;AARE;EACE,iBAAA;EACA,iBAAA;EACA,4BAAA;EACA,UAAA;EACA,mBAAA;EACA,sBAAA;AAUJ;AATI;EACE,WAAA;EACA,iBAAA;AAWN;AATI;EACE,kBAAA;AAWN;AARE;EACE,iBAAA;EACA,iBAAA;EACA,UAAA;EACA,gBAAA;EACA,WDnDS;ECoDT,WAAA;EACA,sBAAA;AAUJ;AARE;EACE,aAAA;EACA,mBAAA;EACA,gBAAA;EACA,UAAA;EACA,iGAAA;EACA,mBAAA;EACA,eAAA;AAUJ;AARE;EACE,iBAAA;EACA,iBAAA;EACA,YAAA;AAUJ;AATI;EACE,gBAAA;EACA,WAAA;AAWN;AATI;EACE,kBAAA;EACA,WAAA;AAWN;AATI;EACE,gBAAA;EACA,WAAA;AAWN;AARE;EACE,eAAA;EACA,WAAA;AAUJ;AARE;EAEE,kBAAA;EACA,4EAAA;EACA,WAAA;EACA,WAAA;AASJ;;AALA;EAEI;IAEE,gBAAA;IACA,4EAAA;IACA,gCAAA;IACA,mCAAA;EAMJ;AACF;AAFA;EAEI;IACE,eAAA;EAGJ;EADE;IACE,iBAAA;EAGJ;EADE;IACE,eAAA;EAGJ;AACF","sourcesContent":["$font-family: 'Thasadith', sans-serif;\n\n$fwb: 700;\n$fwr: 400;\n\n// animation\n$count: 15;\n$size: 50px;\n$margin: $size * -0.5;\n\n$default-color: black;\n$color-text: #fff;\n$color-text-black: #0b0a0a;\n$color-btn: linear-gradient(180deg, rgba(148, 146, 141, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n$color-square: rgba(61, 61, 61, 0.8);\n\n%header-btns {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  border: none;\n  background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n\n  backdrop-filter: blur(10px);\n  width: 100%;\n  height: 100%;\n  transition: 0.2s linear;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n\n%header-mobile-btn {\n  font-size: 2.5rem;\n  line-height: 140%;\n  display: none;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  background: $color-btn;\n  width: 10rem;\n\n  transition: 0.2s linear;\n  margin-top: 1.5rem;\n  margin-left: 1.5rem;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n\n%frame-btns {\n  font-size: 2.5rem;\n  line-height: 140%;\n  width: 10.5rem;\n  background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n  backdrop-filter: blur(10px);\n  transition: 0.2s linear;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n%collect-btn {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  padding: 0.5rem 0rem;\n  max-width: 25.5rem;\n  width: 100%;\n  background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n\n  backdrop-filter: blur(10px);\n  transition: 0.2s linear;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n%popup-btn {\n  font-size: 3rem;\n  line-height: 140%;\n  position: absolute;\n  bottom: 0rem;\n  width: 100%;\n  border: none;\n  background: linear-gradient(180deg, #23221e 0%, rgba(255, 255, 249, 0) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  transition: 0.2s linear;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    background: #3d3d3d;\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n%warning-btns {\n  font-size: 3.5rem;\n  line-height: 140%;\n  border: none;\n  background: linear-gradient(180deg, #23221e 0%, rgba(255, 255, 249, 0) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  text-transform: uppercase;\n  height: 5.5rem;\n  max-width: 20rem;\n  width: 100%;\n  transition: 0.2s linear;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n}\n%close-btn {\n  width: 2.5rem;\n  height: 2.5rem;\n  cursor: pointer;\n  transition: 0.2s linear;\n  &:hover {\n    opacity: 0.5;\n  }\n}\n","@import '../../../../../style/variables.scss';\n\n.popups_result {\n  width: 100%;\n  height: 100%;\n  &_title {\n    font-size: 4rem;\n    line-height: 140%;\n    text-align: center;\n    color: $color-text;\n  }\n  &_table {\n    width: 100%;\n    height: 100%;\n    border-collapse: collapse;\n  }\n  &_thead {\n    height: 10rem;\n    border-bottom: 0.5rem solid #7f7e7c;\n  }\n  &_empty {\n    font-size: 5rem;\n    line-height: 140%;\n    color: $color-text;\n    opacity: 0.3;\n    display: flex;\n    justify-content: center;\n  }\n  &_th {\n    font-size: 4rem;\n    line-height: 140%;\n  }\n  &_tr {\n    position: relative;\n    text-align: center;\n    color: $color-text;\n    transition: linear 0.3s;\n    &:hover:not(:first-child) {\n      background: #7f7e7c;\n      opacity: 0.5;\n    }\n  }\n  &_td {\n    font-size: 2.5rem;\n    line-height: 140%;\n    border: 0.2rem solid #7f7e7c;\n    z-index: 2;\n    padding-top: 0.7rem;\n    padding-bottom: 0.7rem;\n    &:nth-child(1) {\n      width: 7rem;\n      border-left: none;\n    }\n    &:nth-child(4) {\n      border-right: none;\n    }\n  }\n  &_list {\n    font-size: 2.4rem;\n    line-height: 140%;\n    padding: 0;\n    list-style: none;\n    color: $color-text;\n    width: 100%;\n    margin: 0rem 0rem 4rem;\n  }\n  &_wrapper {\n    display: flex;\n    align-items: center;\n    list-style: none;\n    padding: 0;\n    background: linear-gradient(180deg, rgba(148, 146, 141, 0.11) 0%, rgba(255, 255, 255, 0.12) 100%);\n    margin-bottom: 1rem;\n    padding: 0.5rem;\n  }\n  &_item {\n    font-size: 3.5rem;\n    line-height: 140%;\n    color: white;\n    &:nth-child(2) {\n      max-width: 30rem;\n      width: 100%;\n    }\n    &:nth-child(3) {\n      max-width: 18.5rem;\n      width: 100%;\n    }\n    &:nth-child(4) {\n      max-width: 28rem;\n      width: 100%;\n    }\n  }\n  &_count {\n    max-width: 3rem;\n    width: 100%;\n  }\n  &_delete {\n    @extend %close-btn;\n    position: absolute;\n    background: url('../../../../../assets/svg/close-btn.svg') no-repeat center/contain;\n    right: 1rem;\n    top: 1.3rem;\n  }\n}\n\n@media (max-width: 638px) {\n  .popups_result {\n    &_delete {\n      @extend %close-btn;\n      position: static;\n      background: url('../../../../../assets/svg/close-btn.svg') no-repeat center/contain;\n      border-top: 0.2rem solid#7f7e7c;\n      border-bottom: 0.2rem solid #7f7e7c;\n    }\n  }\n}\n\n@media (max-width: 470px) {\n  .popups_result {\n    &_title {\n      font-size: 3rem;\n    }\n    &_td {\n      font-size: 1.6rem;\n    }\n    &_empty {\n      font-size: 3rem;\n    }\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".settings {\n  margin-top: 2rem;\n  max-width: 80rem;\n  width: 100%;\n}\n.settings_title {\n  font-size: 4rem;\n  line-height: 140%;\n  text-align: center;\n  color: #fff;\n  margin: 0;\n}\n.settings_inner {\n  display: flex;\n  justify-content: space-between;\n  margin-left: 1rem;\n  margin-right: 1rem;\n}\n.settings_right {\n  display: flex;\n  flex-direction: column;\n  align-items: flex-start;\n}\n\n@media (max-width: 500px) {\n  .settings_inner {\n    flex-direction: column;\n    justify-content: center;\n    margin: 0;\n  }\n  .settings_title {\n    font-size: 2.1rem;\n    margin-bottom: 1.5rem;\n  }\n}", "",{"version":3,"sources":["webpack://./src/ts/components/main/popups/settings-popup/settings-popup.scss","webpack://./src/style/variables.scss"],"names":[],"mappings":"AAEA;EACE,gBAAA;EACA,gBAAA;EACA,WAAA;AADF;AAEE;EACE,eAAA;EACA,iBAAA;EACA,kBAAA;EACA,WCCS;EDAT,SAAA;AAAJ;AAEE;EACE,aAAA;EACA,8BAAA;EACA,iBAAA;EACA,kBAAA;AAAJ;AAEE;EACE,aAAA;EACA,sBAAA;EACA,uBAAA;AAAJ;;AAIA;EAEI;IACE,sBAAA;IACA,uBAAA;IACA,SAAA;EAFJ;EAIE;IACE,iBAAA;IACA,qBAAA;EAFJ;AACF","sourcesContent":["@import '../../../../../assets/../style/variables.scss';\n\n.settings {\n  margin-top: 2rem;\n  max-width: 80rem;\n  width: 100%;\n  &_title {\n    font-size: 4rem;\n    line-height: 140%;\n    text-align: center;\n    color: $color-text;\n    margin: 0;\n  }\n  &_inner {\n    display: flex;\n    justify-content: space-between;\n    margin-left: 1rem;\n    margin-right: 1rem;\n  }\n  &_right {\n    display: flex;\n    flex-direction: column;\n    align-items: flex-start;\n  }\n}\n\n@media (max-width: 500px) {\n  .settings {\n    &_inner {\n      flex-direction: column;\n      justify-content: center;\n      margin: 0;\n    }\n    &_title {\n      font-size: 2.1rem;\n      margin-bottom: 1.5rem;\n    }\n  }\n}\n","$font-family: 'Thasadith', sans-serif;\n\n$fwb: 700;\n$fwr: 400;\n\n// animation\n$count: 15;\n$size: 50px;\n$margin: $size * -0.5;\n\n$default-color: black;\n$color-text: #fff;\n$color-text-black: #0b0a0a;\n$color-btn: linear-gradient(180deg, rgba(148, 146, 141, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n$color-square: rgba(61, 61, 61, 0.8);\n\n%header-btns {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  border: none;\n  background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n\n  backdrop-filter: blur(10px);\n  width: 100%;\n  height: 100%;\n  transition: 0.2s linear;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n\n%header-mobile-btn {\n  font-size: 2.5rem;\n  line-height: 140%;\n  display: none;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  background: $color-btn;\n  width: 10rem;\n\n  transition: 0.2s linear;\n  margin-top: 1.5rem;\n  margin-left: 1.5rem;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n\n%frame-btns {\n  font-size: 2.5rem;\n  line-height: 140%;\n  width: 10.5rem;\n  background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n  backdrop-filter: blur(10px);\n  transition: 0.2s linear;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n%collect-btn {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  padding: 0.5rem 0rem;\n  max-width: 25.5rem;\n  width: 100%;\n  background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n\n  backdrop-filter: blur(10px);\n  transition: 0.2s linear;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n%popup-btn {\n  font-size: 3rem;\n  line-height: 140%;\n  position: absolute;\n  bottom: 0rem;\n  width: 100%;\n  border: none;\n  background: linear-gradient(180deg, #23221e 0%, rgba(255, 255, 249, 0) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  transition: 0.2s linear;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:disabled {\n    background: #3d3d3d;\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n%warning-btns {\n  font-size: 3.5rem;\n  line-height: 140%;\n  border: none;\n  background: linear-gradient(180deg, #23221e 0%, rgba(255, 255, 249, 0) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  text-transform: uppercase;\n  height: 5.5rem;\n  max-width: 20rem;\n  width: 100%;\n  transition: 0.2s linear;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n    opacity: 0.8;\n  }\n}\n%close-btn {\n  width: 2.5rem;\n  height: 2.5rem;\n  cursor: pointer;\n  transition: 0.2s linear;\n  &:hover {\n    opacity: 0.5;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/***/ "./src/assets/image/firework.gif":
/*!***************************************!*\
  !*** ./src/assets/image/firework.gif ***!
  \***************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "assets/firework.gif";
