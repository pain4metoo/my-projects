...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".settings {\n  margin-top: 2rem;\n  max-width: 80rem;\n  width: 100%;\n}\n.settings_title {\n  font-size: 4rem;\n  line-height: 140%;\n  text-align: center;\n  color: #fff;\n  margin: 0;\n}\n.settings_inner {\n  display: flex;\n  justify-content: space-between;\n  margin-left: 1rem;\n  margin-right: 1rem;\n}\n.settings_right {\n  display: flex;\n  flex-direction: column;\n  align-items: flex-start;\n}\n\n@media (max-width: 480px) {\n  .settings_inner {\n    flex-direction: column;\n    justify-content: center;\n    margin: 0;\n  }\n}", "",{"version":3,"sources":["webpack://./src/ts/components/main/popups/settings-popup/settings-popup.scss","webpack://./src/style/variables.scss"],"names":[],"mappings":"AAEA;EACE,gBAAA;EACA,gBAAA;EACA,WAAA;AADF;AAEE;EACE,eAAA;EACA,iBAAA;EACA,kBAAA;EACA,WCJS;EDKT,SAAA;AAAJ;AAEE;EACE,aAAA;EACA,8BAAA;EACA,iBAAA;EACA,kBAAA;AAAJ;AAEE;EACE,aAAA;EACA,sBAAA;EACA,uBAAA;AAAJ;;AAIA;EAEI;IACE,sBAAA;IACA,uBAAA;IACA,SAAA;EAFJ;AACF","sourcesContent":["@import '../../../../../assets/../style/variables.scss';\n\n.settings {\n  margin-top: 2rem;\n  max-width: 80rem;\n  width: 100%;\n  &_title {\n    font-size: 4rem;\n    line-height: 140%;\n    text-align: center;\n    color: $color-text;\n    margin: 0;\n  }\n  &_inner {\n    display: flex;\n    justify-content: space-between;\n    margin-left: 1rem;\n    margin-right: 1rem;\n  }\n  &_right {\n    display: flex;\n    flex-direction: column;\n    align-items: flex-start;\n  }\n}\n\n@media (max-width: 480px) {\n  .settings {\n    &_inner {\n      flex-direction: column;\n      justify-content: center;\n      margin: 0;\n    }\n  }\n}\n","$font-family: 'Thasadith', sans-serif;\n\n$fwb: 700;\n$fwr: 400;\n\n$default-color: black;\n$color-text: #fff;\n$color-text-black: #0b0a0a;\n$color-btn: linear-gradient(180deg, rgba(148, 146, 141, 0.91) 0%, rgba(255, 255, 255, 0.12) 100%);\n$color-square: rgba(61, 61, 61, 0.8);\n\n%header-btns {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  border: none;\n  background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n  box-shadow: 0px 10px 4px 0px rgba(0, 0, 0, 0.25);\n  backdrop-filter: blur(10px);\n  width: 15rem;\n  transition: 0.2s linear;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n\n%header-mobile-btn {\n  font-size: 2.5rem;\n  line-height: 140%;\n  display: none;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  background: $color-btn;\n  width: 10rem;\n  box-shadow: 0px 10px 4px 0px rgba(0, 0, 0, 0.25);\n  transition: 0.2s linear;\n  margin-top: 1.5rem;\n  margin-left: 1.5rem;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n\n%frame-btns {\n  font-size: 2.5rem;\n  line-height: 140%;\n  width: 10.5rem;\n  background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n  box-shadow: 0px 10px 4px 0px rgba(0, 0, 0, 0.25);\n  backdrop-filter: blur(10px);\n  transition: 0.2s linear;\n  border: none;\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n%collect-btn {\n  font-size: 2.5rem;\n  line-height: 140%;\n  border: none;\n  color: $color-text;\n  padding: 0.5rem 0rem;\n  max-width: 20.5rem;\n  width: 100%;\n  background: linear-gradient(180deg, rgba(170, 170, 170, 0.91) 0%, #2e2d2c 100%);\n  box-shadow: 0px 10px 4px 0px rgba(0, 0, 0, 0.25);\n  backdrop-filter: blur(10px);\n  transition: 0.2s linear;\n  cursor: pointer;\n  user-select: none;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n  &:disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n%popup-btn {\n  font-size: 3rem;\n  line-height: 140%;\n  position: absolute;\n  bottom: 0rem;\n  width: 100%;\n  border: none;\n  background: linear-gradient(180deg, #23221e 0%, rgba(255, 255, 249, 0) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  transition: 0.2s linear;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n  &:disabled {\n    background: #3d3d3d;\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n}\n%warning-btns {\n  font-size: 3.5rem;\n  line-height: 140%;\n  border: none;\n  background: linear-gradient(180deg, #23221e 0%, rgba(255, 255, 249, 0) 100%);\n  color: $color-text;\n  cursor: pointer;\n  user-select: none;\n  text-transform: uppercase;\n  height: 5.5rem;\n  max-width: 20rem;\n  width: 100%;\n  transition: 0.2s linear;\n  &:hover {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n  &:active {\n    box-shadow: 0px 0px 0.72px 0px #fff, 0px 0px 1.44px 0px #fff, 0px 0px 5.04px 0px #fff, 0px 0px 10.08px 0px #fff,\n      0px 0px 17.28px 0px #fff, 0px 0px 30.24px 0px #fff;\n  }\n}\n%close-btn {\n  width: 3rem;\n  height: 3rem;\n  cursor: pointer;\n  transition: 0.2s linear;\n  &:hover {\n    opacity: 0.5;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/******/ })()
;
//# sourceMappingURL=bundle-4652d70931f6f68cf478.js.map